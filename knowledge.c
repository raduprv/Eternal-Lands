...
int display_knowledge_handler(window_info *win)
{
	...
	// window separators
	glVertex3i(0,200,0);
	glVertex3i(knowledge_menu_x_len,200,0);
	glVertex3i(0,300,0);
	glVertex3i(knowledge_menu_x_len,300,0);
	//scroll bar
	glVertex3i(knowledge_menu_x_len-20,20,0);
	glVertex3i(knowledge_menu_x_len-20,200,0);
	glVertex3i(knowledge_menu_x_len-15,30,0);
	glVertex3i(knowledge_menu_x_len-10,25,0);
	glVertex3i(knowledge_menu_x_len-10,25,0);
	glVertex3i(knowledge_menu_x_len-5,30,0);
	glVertex3i(knowledge_menu_x_len-15,185,0);
	glVertex3i(knowledge_menu_x_len-10,190,0);
	glVertex3i(knowledge_menu_x_len-10,190,0);
	glVertex3i(knowledge_menu_x_len-5,185,0);
	//progress bar
	...
	glBegin(GL_QUADS);
	//scroll bar
	glVertex3i(knowledge_menu_x_len-13,35+scroll,0);
	glVertex3i(knowledge_menu_x_len-7,35+scroll,0);
	glVertex3i(knowledge_menu_x_len-7,55+scroll,0);
	glVertex3i(knowledge_menu_x_len-13,55+scroll,0);
	//progress bar
