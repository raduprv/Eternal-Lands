...
SGE R3.xy, light_position_0.wwww, constant.xzxx;
...
SGE R3.xy, light_position_1.wwww, constant.xzxx;
MAD R2.w, R2.w, R3.x, R3.y;
DP3 R4.x, R1.xyzx, R5.xyzx;
MAX R1.x, R4.x, constant.z;
MUL R1.x, R1.x, R2.w;
...
SGE R3.xy, light_position_2.wwww, constant.xzxx;
MAD R2.w, R2.w, R3.x, R3.y;
DP3 R4.x, R1.xyzx, R5.xyzx;
MAX R1.x, R4.x, constant.z;
MUL R1.x, R1.x, R2.w;
...
SGE R3.xy, light_position_3.wwww, constant.xzxx;
MAD R2.w, R2.w, R3.x, R3.y;
DP3 R4.x, R1.xyzx, R5.xyzx;
MAX R1.x, R4.x, constant.z;
MUL R1.x, R1.x, R2.w;
...
SGE R3.xy, light_position_4.wwww, constant.xzxx;
MAD R2.w, R2.w, R3.x, R3.y;
DP3 R4.x, R1.xyzx, R5.xyzx;
MAX R1.x, R4.x, constant.z;
MUL R1.x, R1.x, R2.w;
...
SGE R3.xy, light_position_5.wwww, constant.xzxx;
MAD R2.w, R2.w, R3.x, R3.y;
DP3 R4.x, R1.xyzx, R5.xyzx;
MAX R1.x, R4.x, constant.z;
MUL R1.x, R1.x, R2.w;
...
SGE R3.xy, light_position_6.wwww, constant.xzxx;
MAD R2.w, R2.w, R3.x, R3.y;
DP3 R4.x, R1.xyzx, R5.xyzx;
MAX R1.x, R4.x, constant.z;
MUL R1.x, R1.x, R2.w;
...
SGE R3.xy, light_position_7.wwww, constant.xzxx;
MAD R2.w, R2.w, R3.x, R3.y;
DP3 R4.x, R1.xyzx, R5.xyzx;
MAX R1.x, R4.x, constant.z;
MUL R1.x, R1.x, R2.w;
