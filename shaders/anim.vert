...
PARAM diffuse_0 = state.light[0].diffuse;
PARAM diffuse_1 = state.light[1].diffuse;
PARAM diffuse_2 = state.light[2].diffuse;
PARAM diffuse_3 = state.light[3].diffuse;
PARAM diffuse_4 = state.light[4].diffuse;
PARAM diffuse_5 = state.light[5].diffuse;
PARAM diffuse_6 = state.light[6].diffuse;
PARAM diffuse_7 = state.light[7].diffuse;
...
RCP R2.w, R2.w;
MUL R1.x, R1.x, R2.w;
MAD R7, R1.xxxx, diffuse_0, scene_color;
