...
int display_edit_window_handler()
{
	...
	if(ew_selected_object!=-1){
		...
		// Drawing object info
		snprintf(temp,99,"X Pos: %03.2f",objects_list[ew_selected_object]->x_pos);
		draw_string(10,10,temp,1);
		draw_string(160,10,"+ -",1);
		snprintf(temp,99,"Y Pos: %03.2f",objects_list[ew_selected_object]->y_pos);
		draw_string(10,30,temp,1);
		draw_string(160,30,"+ -",1);
		snprintf(temp,99,"Z Pos: %03.2f",objects_list[ew_selected_object]->z_pos);
		draw_string(10,50,temp,1);
		draw_string(160,50,"+ -",1);
		
		snprintf(temp,99,"X Rot: %03.2f",objects_list[ew_selected_object]->x_rot);
		...
		snprintf(temp,99,"Z Rot: %03.2f",objects_list[ew_selected_object]->z_rot);
		...
		snprintf(temp,99,"File Name: %s",objects_list[ew_selected_object]->file_name);
...
int check_edit_window_interface()
{
   ...
   if(x>g1_x1 && x<=g1_x2 && y>g1_y1 && y<=g1_y2)objects_list[ew_selected_object]->x_pos+=(shift_on)?(ctrl_on?0.001:(alt_on?0.01:0.1)):(ctrl_on?100:(alt_on?10:1));
   if(x>g2_x1 && x<=g2_x2 && y>g2_y1 && y<=g2_y2)objects_list[ew_selected_object]->x_pos-=(shift_on)?(ctrl_on?0.001:(alt_on?0.01:0.1)):(ctrl_on?100:(alt_on?10:1));
   if(x>g3_x1 && x<=g3_x2 && y>g3_y1 && y<=g3_y2)objects_list[ew_selected_object]->y_pos+=(shift_on)?(ctrl_on?0.001:(alt_on?0.01:0.1)):(ctrl_on?100:(alt_on?10:1));
   if(x>g4_x1 && x<=g4_x2 && y>g4_y1 && y<=g4_y2)objects_list[ew_selected_object]->y_pos-=(shift_on)?(ctrl_on?0.001:(alt_on?0.01:0.1)):(ctrl_on?100:(alt_on?10:1));
   if(x>g5_x1 && x<=g5_x2 && y>g5_y1 && y<=g5_y2)objects_list[ew_selected_object]->z_pos+=(shift_on)?(ctrl_on?0.001:(alt_on?0.01:0.1)):(ctrl_on?100:(alt_on?10:1));
   if(x>g6_x1 && x<=g6_x2 && y>g6_y1 && y<=g6_y2)objects_list[ew_selected_object]->z_pos-=(shift_on)?(ctrl_on?0.001:(alt_on?0.01:0.1)):(ctrl_on?100:(alt_on?10:1));

   if(x>g7_x1 && x<=g7_x2 && y>g7_y1 && y<=g7_y2)objects_list[ew_selected_object]->x_rot+=(shift_on)?(ctrl_on?0.001:(alt_on?0.01:0.1)):(ctrl_on?100:(alt_on?10:1));
   if(x>g8_x1 && x<=g8_x2 && y>g8_y1 && y<=g8_y2)objects_list[ew_selected_object]->x_rot-=(shift_on)?(ctrl_on?0.001:(alt_on?0.01:0.1)):(ctrl_on?100:(alt_on?10:1));
   if(x>g9_x1 && x<=g9_x2 && y>g9_y1 && y<=g9_y2)objects_list[ew_selected_object]->y_rot+=(shift_on)?(ctrl_on?0.001:(alt_on?0.01:0.1)):(ctrl_on?100:(alt_on?10:1));
   if(x>g10_x1 && x<=g10_x2 && y>g10_y1 && y<=g10_y2)objects_list[ew_selected_object]->y_rot-=(shift_on)?(ctrl_on?0.001:(alt_on?0.01:0.1)):(ctrl_on?100:(alt_on?10:1));
   if(x>g11_x1 && x<=g11_x2 && y>g11_y1 && y<=g11_y2)objects_list[ew_selected_object]->z_rot+=(shift_on)?(ctrl_on?0.001:(alt_on?0.01:0.1)):(ctrl_on?100:(alt_on?10:1));
   if(x>g12_x1 && x<=g12_x2 && y>g12_y1 && y<=g12_y2)objects_list[ew_selected_object]->z_rot-=(shift_on)?(ctrl_on?0.001:(alt_on?0.01:0.1)):(ctrl_on?100:(alt_on?10:1));

   if(x>g13_x1 && x<=g13_x2 && y>g13_y1 && y<=g13_y2)objects_list[ew_selected_object]->r+=(shift_on)?(ctrl_on?0.001:(alt_on?0.01:0.1)):(ctrl_on?100:(alt_on?10:1));
   if(x>g14_x1 && x<=g14_x2 && y>g14_y1 && y<=g14_y2)objects_list[ew_selected_object]->r-=(shift_on)?(ctrl_on?0.001:(alt_on?0.01:0.1)):(ctrl_on?100:(alt_on?10:1));
   if(x>g15_x1 && x<=g15_x2 && y>g15_y1 && y<=g15_y2)objects_list[ew_selected_object]->g+=(shift_on)?(ctrl_on?0.001:(alt_on?0.01:0.1)):(ctrl_on?100:(alt_on?10:1));
   if(x>g16_x1 && x<=g16_x2 && y>g16_y1 && y<=g16_y2)objects_list[ew_selected_object]->g-=(shift_on)?(ctrl_on?0.001:(alt_on?0.01:0.1)):(ctrl_on?100:(alt_on?10:1));
   if(x>g17_x1 && x<=g17_x2 && y>g17_y1 && y<=g17_y2)objects_list[ew_selected_object]->b+=(shift_on)?(ctrl_on?0.001:(alt_on?0.01:0.1)):(ctrl_on?100:(alt_on?10:1));
   if(x>g18_x1 && x<=g18_x2 && y>g18_y1 && y<=g18_y2)objects_list[ew_selected_object]->b-=(shift_on)?(ctrl_on?0.001:(alt_on?0.01:0.1)):(ctrl_on?100:(alt_on?10:1));

   if(x>g19_x1 && x<=g19_x2 && y>g19_y1 && y<=g19_y2)objects_list[ew_selected_object]->blended=!objects_list[ew_selected_object]->blended;
   if(x>g20_x1 && x<=g20_x2 && y>g20_y1 && y<=g20_y2)objects_list[ew_selected_object]->self_lit=!objects_list[ew_selected_object]->self_lit;
