...
void display_items_menu()
{
	if(items_win < 0){
#ifdef WINDOW_CHAT
		items_win= create_window("Inventory", root_win, 0, items_menu_x, items_menu_y, items_menu_x_len, items_menu_y_len, ELW_WIN_DEFAULT);
#else
...
#ifdef WINDOW_CHAT
		ground_items_win= create_window("Bag", root_win, 0, ground_items_menu_x, ground_items_menu_y, ground_items_menu_x_len, ground_items_menu_y_len, ELW_WIN_DEFAULT);
#else
