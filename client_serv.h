...
typedef enum {
	...
	SPECIAL_EFFECT_BARRICADE_GOES_BOOM = 67,
	SPECIAL_EFFECT_MANA_DRAINER_GOES_BOOM = 68,
	SPECIAL_EFFECT_MANA_BURNER_GOES_BOOM = 69,
	SPECIAL_EFFECT_UNINVIZIBILIZER_GOES_BOOM = 70,
	SPECIAL_EFFECT_MAGIC_IMMUNITY_REMOVAL_GOES_BOOM = 71
} special_effect_enum;
	/*! @} */
