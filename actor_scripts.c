...
void init_actor_defs()
{
	...
	my_strcp(actors_defs[human_female].cape[CAPE_QUELL].model_name,"./md2/cape1_tallf.md2");
	my_strcp(actors_defs[human_female].cape[CAPE_QUELL].skin_name,"./md2/cape_quell.bmp");
	...
	my_strcp(actors_defs[human_male].cape[CAPE_QUELL].model_name,"./md2/cape1_tallm.md2");
	my_strcp(actors_defs[human_male].cape[CAPE_QUELL].skin_name,"./md2/cape_quell.bmp");
	...
	my_strcp(actors_defs[elf_female].cape[CAPE_QUELL].model_name,"./md2/cape1_tallf.md2");
	my_strcp(actors_defs[elf_female].cape[CAPE_QUELL].skin_name,"./md2/cape_quell.bmp");
	...
	my_strcp(actors_defs[elf_male].cape[CAPE_QUELL].model_name,"./md2/cape1_tallm.md2");
	my_strcp(actors_defs[elf_male].cape[CAPE_QUELL].skin_name,"./md2/cape_quell.bmp");
	...
	my_strcp(actors_defs[dwarf_female].cape[CAPE_QUELL].model_name,"./md2/cape1_shortf.md2");
	my_strcp(actors_defs[dwarf_female].cape[CAPE_QUELL].skin_name,"./md2/cape_quell.bmp");
	...
	my_strcp(actors_defs[dwarf_male].cape[CAPE_QUELL].model_name,"./md2/cape1_shortm.md2");
	my_strcp(actors_defs[dwarf_male].cape[CAPE_QUELL].skin_name,"./md2/cape_quell.bmp");
	...
	my_strcp(actors_defs[gnome_female].cape[CAPE_QUELL].model_name,"./md2/cape1_gnomef.md2");
	my_strcp(actors_defs[gnome_female].cape[CAPE_QUELL].skin_name,"./md2/cape_quell.bmp");
	...
	my_strcp(actors_defs[gnome_male].cape[CAPE_QUELL].model_name,"./md2/cape1_gnomem.md2");
	my_strcp(actors_defs[gnome_male].cape[CAPE_QUELL].skin_name,"./md2/cape_quell.bmp");
	...
	//////////////////////////////////////////////////////////////////////////////////////////
	/////////////////////////////////////////////////////////////////////////////
	actors_defs[orchan_female].ghost=0;
	my_strcp(actors_defs[orchan_female].skin_name,"./md2/orchan_female.bmp");
	my_strcp(actors_defs[orchan_female].file_name,"./md2/orchan_female.md2");
	my_strcp(actors_defs[orchan_female].walk_frame,"walk01");
	my_strcp(actors_defs[orchan_female].run_frame,"run01");
	my_strcp(actors_defs[orchan_female].die1_frame,"dief01");
	my_strcp(actors_defs[orchan_female].die2_frame,"dieb11");
	my_strcp(actors_defs[orchan_female].pain1_frame,"pain01");
	my_strcp(actors_defs[orchan_female].pick_frame,"pickup01");
	my_strcp(actors_defs[orchan_female].drop_frame,"drop01");
	my_strcp(actors_defs[orchan_female].idle_frame,"idle01");
	my_strcp(actors_defs[orchan_female].idle_sit_frame,"sitidle01");
	my_strcp(actors_defs[orchan_female].harvest_frame,"harvest01");
	my_strcp(actors_defs[orchan_female].attack_cast_frame,"cast01");
	my_strcp(actors_defs[orchan_female].sit_down_frame,"intosit01");
	my_strcp(actors_defs[orchan_female].stand_up_frame,"outsit01");
	my_strcp(actors_defs[orchan_female].in_combat_frame,"intofight01");
	my_strcp(actors_defs[orchan_female].out_combat_frame,"outfight01");
	my_strcp(actors_defs[orchan_female].combat_idle_frame,"fightidle01");

	my_strcp(actors_defs[orchan_female].shirt[SHIRT_BLACK].arms_name,"./md2/arms1_black.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_BLACK].model_name,"./md2/torso1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_BLACK].torso_name,"./md2/torso1_black.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_BLUE].arms_name,"./md2/arms1_blue.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_BLUE].model_name,"./md2/torso1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_BLUE].torso_name,"./md2/torso1_blue.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_BROWN].arms_name,"./md2/arms1_brown.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_BROWN].model_name,"./md2/torso1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_BROWN].torso_name,"./md2/torso1_brown.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_GREY].arms_name,"./md2/arms1_gray.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_GREY].model_name,"./md2/torso1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_GREY].torso_name,"./md2/torso1_gray.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_GREEN].arms_name,"./md2/arms1_green.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_GREEN].model_name,"./md2/torso1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_GREEN].torso_name,"./md2/torso1_green.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_LIGHTBROWN].arms_name,"./md2/arms1_lightbrown.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_LIGHTBROWN].model_name,"./md2/torso1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_LIGHTBROWN].torso_name,"./md2/torso1_lightbrown.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_ORANGE].arms_name,"./md2/arms1_orange.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_ORANGE].model_name,"./md2/torso1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_ORANGE].torso_name,"./md2/torso1_orange.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_PINK].arms_name,"./md2/arms1_pink.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_PINK].model_name,"./md2/torso1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_PINK].torso_name,"./md2/torso1_pink.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_PURPLE].arms_name,"./md2/arms1_purple.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_PURPLE].model_name,"./md2/torso1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_PURPLE].torso_name,"./md2/torso1_purple.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_RED].arms_name,"./md2/arms1_red.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_RED].model_name,"./md2/torso1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_RED].torso_name,"./md2/torso1_red.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_WHITE].arms_name,"./md2/arms1_white.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_WHITE].model_name,"./md2/torso1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_WHITE].torso_name,"./md2/torso1_white.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_YELLOW].arms_name,"./md2/arms1_yellow.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_YELLOW].model_name,"./md2/torso1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_YELLOW].torso_name,"./md2/torso1_yellow.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_LEATHER_ARMOR].arms_name,"./md2/arms2.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_LEATHER_ARMOR].model_name,"./md2/torso1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_LEATHER_ARMOR].torso_name,"./md2/torso2.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_CHAIN_ARMOR].arms_name,"./md2/arms3.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_CHAIN_ARMOR].model_name,"./md2/torso1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_CHAIN_ARMOR].torso_name,"./md2/torso3.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_STEEL_CHAIN_ARMOR].arms_name,"./md2/arms4.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_STEEL_CHAIN_ARMOR].model_name,"./md2/torso1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_STEEL_CHAIN_ARMOR].torso_name,"./md2/torso4.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_TITANIUM_CHAIN_ARMOR].arms_name,"./md2/arms5.bmp");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_TITANIUM_CHAIN_ARMOR].model_name,"./md2/torso1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].shirt[SHIRT_TITANIUM_CHAIN_ARMOR].torso_name,"./md2/torso5.bmp");

	my_strcp(actors_defs[orchan_female].shirt[SHIRT_IRON_PLATE_ARMOR].arms_name,"./md2/arms6.bmp");
	...
	my_strcp(actors_defs[orchan_female].skin[SKIN_NORMAL].head_name,"./md2/head_orchanfgreen.bmp");
	my_strcp(actors_defs[orchan_female].skin[SKIN_PALE].hands_name,"./md2/hands_orchanpurple.bmp");
	my_strcp(actors_defs[orchan_female].skin[SKIN_PALE].head_name,"./md2/head_orchanfpurple.bmp");
	my_strcp(actors_defs[orchan_female].skin[SKIN_TAN].hands_name,"./md2/hands_tan.bmp");
	my_strcp(actors_defs[orchan_female].skin[SKIN_TAN].head_name,"./md2/head_orchanftan.bmp");

	my_strcp(actors_defs[orchan_female].hair[HAIR_BLACK].hair_name,"./md2/hair_black.bmp");
	my_strcp(actors_defs[orchan_female].hair[HAIR_BLOND].hair_name,"./md2/hair_blond.bmp");
	my_strcp(actors_defs[orchan_female].hair[HAIR_BROWN].hair_name,"./md2/hair_brown.bmp");
	my_strcp(actors_defs[orchan_female].hair[HAIR_GRAY].hair_name,"./md2/hair_gray.bmp");
	my_strcp(actors_defs[orchan_female].hair[HAIR_RED].hair_name,"./md2/hair_red.bmp");
	my_strcp(actors_defs[orchan_female].hair[HAIR_WHITE].hair_name,"./md2/hair_white.bmp");

	my_strcp(actors_defs[orchan_female].boots[BOOTS_BLACK].boots_name,"./md2/boots1_black.bmp");
	my_strcp(actors_defs[orchan_female].boots[BOOTS_BROWN].boots_name,"./md2/boots1_brown.bmp");
	my_strcp(actors_defs[orchan_female].boots[BOOTS_DARKBROWN].boots_name,"./md2/boots1_darkbrown.bmp");
	my_strcp(actors_defs[orchan_female].boots[BOOTS_DULLBROWN].boots_name,"./md2/boots1_dullbrown.bmp");
	my_strcp(actors_defs[orchan_female].boots[BOOTS_LIGHTBROWN].boots_name,"./md2/boots1_lightbrown.bmp");
	my_strcp(actors_defs[orchan_female].boots[BOOTS_ORANGE].boots_name,"./md2/boots1_orange.bmp");
	my_strcp(actors_defs[orchan_female].boots[BOOTS_LEATHER].boots_name,"./md2/boots2.bmp");
	my_strcp(actors_defs[orchan_female].boots[BOOTS_FUR].boots_name,"./md2/boots3.bmp");
	my_strcp(actors_defs[orchan_female].boots[BOOTS_IRON_GREAVE].boots_name,"./md2/boots4.bmp");

	my_strcp(actors_defs[orchan_female].legs[PANTS_BLACK].legs_name,"./md2/pants1_black.bmp");
	my_strcp(actors_defs[orchan_female].legs[PANTS_BLACK].model_name,"./md2/legs1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].legs[PANTS_BLUE].legs_name,"./md2/pants1_blue.bmp");
	my_strcp(actors_defs[orchan_female].legs[PANTS_BLUE].model_name,"./md2/legs1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].legs[PANTS_BROWN].legs_name,"./md2/pants1_brown.bmp");
	my_strcp(actors_defs[orchan_female].legs[PANTS_BROWN].model_name,"./md2/legs1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].legs[PANTS_DARKBROWN].legs_name,"./md2/pants1_darkbrown.bmp");
	my_strcp(actors_defs[orchan_female].legs[PANTS_DARKBROWN].model_name,"./md2/legs1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].legs[PANTS_GREY].legs_name,"./md2/pants1_gray.bmp");
	my_strcp(actors_defs[orchan_female].legs[PANTS_GREY].model_name,"./md2/legs1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].legs[PANTS_GREEN].legs_name,"./md2/pants1_green.bmp");
	my_strcp(actors_defs[orchan_female].legs[PANTS_GREEN].model_name,"./md2/legs1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].legs[PANTS_LIGHTBROWN].legs_name,"./md2/pants1_lightbrown.bmp");
	my_strcp(actors_defs[orchan_female].legs[PANTS_LIGHTBROWN].model_name,"./md2/legs1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].legs[PANTS_RED].legs_name,"./md2/pants1_red.bmp");
	my_strcp(actors_defs[orchan_female].legs[PANTS_RED].model_name,"./md2/legs1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].legs[PANTS_WHITE].legs_name,"./md2/pants1_white.bmp");
	my_strcp(actors_defs[orchan_female].legs[PANTS_WHITE].model_name,"./md2/legs1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].legs[PANTS_LEATHER].legs_name,"./md2/pants2.bmp");
	my_strcp(actors_defs[orchan_female].legs[PANTS_LEATHER].model_name,"./md2/legs1_orchanf.md2");
	...
	my_strcp(actors_defs[orchan_female].cape[CAPE_BLUE].model_name,"./md2/cape1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].cape[CAPE_BLUE].skin_name,"./md2/cape1_blue.bmp");
	my_strcp(actors_defs[orchan_female].cape[CAPE_BLUEGRAY].model_name,"./md2/cape1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].cape[CAPE_BLUEGRAY].skin_name,"./md2/cape1_bluegray.bmp");
	my_strcp(actors_defs[orchan_female].cape[CAPE_BROWN].model_name,"./md2/cape1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].cape[CAPE_BROWN].skin_name,"./md2/cape1_brown.bmp");
	my_strcp(actors_defs[orchan_female].cape[CAPE_BROWNGRAY].model_name,"./md2/cape1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].cape[CAPE_BROWNGRAY].skin_name,"./md2/cape1_browngray.bmp");
	my_strcp(actors_defs[orchan_female].cape[CAPE_GRAY].model_name,"./md2/cape1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].cape[CAPE_GRAY].skin_name,"./md2/cape1_gray.bmp");
	my_strcp(actors_defs[orchan_female].cape[CAPE_GREEN].model_name,"./md2/cape1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].cape[CAPE_GREEN].skin_name,"./md2/cape1_green.bmp");
	my_strcp(actors_defs[orchan_female].cape[CAPE_GREENGRAY].model_name,"./md2/cape1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].cape[CAPE_GREENGRAY].skin_name,"./md2/cape1_greengray.bmp");
	my_strcp(actors_defs[orchan_female].cape[CAPE_PURPLE].model_name,"./md2/cape1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].cape[CAPE_PURPLE].skin_name,"./md2/cape1_purple.bmp");
	my_strcp(actors_defs[orchan_female].cape[CAPE_WHITE].model_name,"./md2/cape1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].cape[CAPE_WHITE].skin_name,"./md2/cape1_white.bmp");
	my_strcp(actors_defs[orchan_female].cape[CAPE_GOLD].model_name,"./md2/cape1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].cape[CAPE_GOLD].skin_name,"./md2/cape1_gold.bmp");
	my_strcp(actors_defs[orchan_female].cape[CAPE_RED].model_name,"./md2/cape1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].cape[CAPE_RED].skin_name,"./md2/cape1_red.bmp");
	my_strcp(actors_defs[orchan_female].cape[CAPE_ORANGE].model_name,"./md2/cape1_orchanf.md2");
	...
	my_strcp(actors_defs[orchan_female].cape[CAPE_QUELL].model_name,"./md2/cape1_orchanf.md2");
	my_strcp(actors_defs[orchan_female].cape[CAPE_QUELL].skin_name,"./md2/cape_quell.bmp");
	...
	my_strcp(actors_defs[orchan_female].head[HEAD_3].model_name,"./md2/head3_orchanf.md2");
	my_strcp(actors_defs[orchan_female].head[HEAD_4].model_name,"./md2/head4_orchanf.md2");
	my_strcp(actors_defs[orchan_female].head[HEAD_5].model_name,"./md2/head1_orchanf.md2");

	my_strcp(actors_defs[orchan_female].shield[SHIELD_WOOD].model_name,"./md2/shield1_tall.md2");
	my_strcp(actors_defs[orchan_female].shield[SHIELD_WOOD].skin_name,"./md2/shield1_wood1.bmp");
	my_strcp(actors_defs[orchan_female].shield[SHIELD_WOOD_ENHANCED].model_name,"./md2/shield1_tall.md2");
	my_strcp(actors_defs[orchan_female].shield[SHIELD_WOOD_ENHANCED].skin_name,"./md2/shield1_wood2.bmp");
	my_strcp(actors_defs[orchan_female].shield[SHIELD_IRON].model_name,"./md2/shield1_tall.md2");
	my_strcp(actors_defs[orchan_female].shield[SHIELD_IRON].skin_name,"./md2/shield1_iron.bmp");
	my_strcp(actors_defs[orchan_female].shield[SHIELD_STEEL].model_name,"./md2/shield1_tall.md2");
	my_strcp(actors_defs[orchan_female].shield[SHIELD_STEEL].skin_name,"./md2/shield1_steel.bmp");


	my_strcp(actors_defs[orchan_female].weapon[WEAPON_NONE].model_name,none);
	my_strcp(actors_defs[orchan_female].weapon[WEAPON_NONE].skin_name,none);
	my_strcp(actors_defs[orchan_female].weapon[WEAPON_NONE].attack_up1,"punchone01");
	my_strcp(actors_defs[orchan_female].weapon[WEAPON_NONE].attack_up2,"punchtwo01");
	my_strcp(actors_defs[orchan_female].weapon[WEAPON_NONE].attack_down1,"kickone01");
	my_strcp(actors_defs[orchan_female].weapon[WEAPON_NONE].attack_down2,"kicktwo01");

	my_strcp(actors_defs[orchan_female].weapon[GLOVE_FUR].model_name,none);
	my_strcp(actors_defs[orchan_female].weapon[GLOVE_FUR].skin_name,"./md2/gloves_fur.bmp");
	my_strcp(actors_defs[orchan_female].weapon[GLOVE_FUR].attack_up1,"punchone01");
	my_strcp(actors_defs[orchan_female].weapon[GLOVE_FUR].attack_up2,"punchtwo01");
	my_strcp(actors_defs[orchan_female].weapon[GLOVE_FUR].attack_down1,"kickone01");
	my_strcp(actors_defs[orchan_female].weapon[GLOVE_FUR].attack_down2,"kicktwo01");
	actors_defs[orchan_female].weapon[GLOVE_FUR].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_female].weapon[GLOVE_LEATHER].model_name,none);
	my_strcp(actors_defs[orchan_female].weapon[GLOVE_LEATHER].skin_name,"./md2/gloves_leather.bmp");
	my_strcp(actors_defs[orchan_female].weapon[GLOVE_LEATHER].attack_up1,"punchone01");
	my_strcp(actors_defs[orchan_female].weapon[GLOVE_LEATHER].attack_up2,"punchtwo01");
	my_strcp(actors_defs[orchan_female].weapon[GLOVE_LEATHER].attack_down1,"kickone01");
	my_strcp(actors_defs[orchan_female].weapon[GLOVE_LEATHER].attack_down2,"kicktwo01");
	actors_defs[orchan_female].weapon[GLOVE_LEATHER].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_1].model_name,"./md2/sword1_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_1].skin_name,"./md2/sword1.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_1].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_1].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_1].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_1].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_1].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_1_FIRE].model_name,"./md2/sword1_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_1_FIRE].skin_name,"./md2/sword1.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_1_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_1_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_1_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_1_FIRE].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_1_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_2].model_name,"./md2/sword2_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_2].skin_name,"./md2/sword2.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_2].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_2].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_2].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_2].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_2].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_2_FIRE].model_name,"./md2/sword2_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_2_FIRE].skin_name,"./md2/sword2.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_2_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_2_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_2_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_2_FIRE].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_2_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_2_COLD].model_name,"./md2/sword2_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_2_COLD].skin_name,"./md2/sword2.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_2_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_2_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_2_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_2_COLD].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_2_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_3].model_name,"./md2/sword3_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_3].skin_name,"./md2/sword3.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_3].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_3].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_3].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_3].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_3].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_3_FIRE].model_name,"./md2/sword3_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_3_FIRE].skin_name,"./md2/sword3.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_3_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_3_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_3_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_3_FIRE].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_3_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_3_COLD].model_name,"./md2/sword3_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_3_COLD].skin_name,"./md2/sword3.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_3_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_3_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_3_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_3_COLD].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_3_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_3_MAGIC].model_name,"./md2/sword3_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_3_MAGIC].skin_name,"./md2/sword3.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_3_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_3_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_3_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_3_MAGIC].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_3_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_4].model_name,"./md2/sword4_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4].skin_name,"./md2/sword4.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_4].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_FIRE].model_name,"./md2/sword4_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_FIRE].skin_name,"./md2/sword4.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_FIRE].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_4_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_COLD].model_name,"./md2/sword4_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_COLD].skin_name,"./md2/sword4.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_COLD].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_4_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_MAGIC].model_name,"./md2/sword4_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_MAGIC].skin_name,"./md2/sword4.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_MAGIC].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_4_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_THERMAL].model_name,"./md2/sword4_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_THERMAL].skin_name,"./md2/sword4.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_THERMAL].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_THERMAL].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_THERMAL].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_4_THERMAL].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_4_THERMAL].glow=GLOW_THERMAL;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_5].model_name,"./md2/sword5_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5].skin_name,"./md2/sword5.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_5].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_FIRE].model_name,"./md2/sword5_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_FIRE].skin_name,"./md2/sword5.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_FIRE].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_5_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_COLD].model_name,"./md2/sword5_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_COLD].skin_name,"./md2/sword5.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_COLD].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_5_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_MAGIC].model_name,"./md2/sword5_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_MAGIC].skin_name,"./md2/sword5.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_MAGIC].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_5_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_THERMAL].model_name,"./md2/sword5_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_THERMAL].skin_name,"./md2/sword5.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_THERMAL].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_THERMAL].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_THERMAL].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_5_THERMAL].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_5_THERMAL].glow=GLOW_THERMAL;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_6].model_name,"./md2/sword6_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6].skin_name,"./md2/sword6.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_6].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_FIRE].model_name,"./md2/sword6_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_FIRE].skin_name,"./md2/sword6.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_FIRE].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_6_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_COLD].model_name,"./md2/sword6_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_COLD].skin_name,"./md2/sword6.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_COLD].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_6_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_MAGIC].model_name,"./md2/sword6_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_MAGIC].skin_name,"./md2/sword6.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_MAGIC].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_6_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_THERMAL].model_name,"./md2/sword6_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_THERMAL].skin_name,"./md2/sword6.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_THERMAL].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_THERMAL].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_THERMAL].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_6_THERMAL].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_6_THERMAL].glow=GLOW_THERMAL;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_7].model_name,"./md2/sword7_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7].skin_name,"./md2/sword7.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_7].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_FIRE].model_name,"./md2/sword7_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_FIRE].skin_name,"./md2/sword7.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_FIRE].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_7_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_COLD].model_name,"./md2/sword7_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_COLD].skin_name,"./md2/sword7.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_COLD].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_7_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_MAGIC].model_name,"./md2/sword7_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_MAGIC].skin_name,"./md2/sword7.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_MAGIC].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_7_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_THERMAL].model_name,"./md2/sword7_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_THERMAL].skin_name,"./md2/sword7.bmp");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_THERMAL].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_THERMAL].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_THERMAL].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[SWORD_7_THERMAL].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[SWORD_7_THERMAL].glow=GLOW_THERMAL;

	my_strcp(actors_defs[orchan_female].weapon[STAFF_1].model_name,"./md2/staff1_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[STAFF_1].skin_name,"./md2/staff1_brown.bmp");
	my_strcp(actors_defs[orchan_female].weapon[STAFF_1].attack_up1,"slashtwo01");
	my_strcp(actors_defs[orchan_female].weapon[STAFF_1].attack_up2,"slashtwo01");
	my_strcp(actors_defs[orchan_female].weapon[STAFF_1].attack_down1,"hacktwo01");
	my_strcp(actors_defs[orchan_female].weapon[STAFF_1].attack_down2,"hacktwo01");
	actors_defs[orchan_female].weapon[STAFF_1].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_female].weapon[STAFF_2].model_name,"./md2/staff1_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[STAFF_2].skin_name,"./md2/staff1_green.bmp");
	my_strcp(actors_defs[orchan_female].weapon[STAFF_2].attack_up1,"slashtwo01");
	my_strcp(actors_defs[orchan_female].weapon[STAFF_2].attack_up2,"slashtwo01");
	my_strcp(actors_defs[orchan_female].weapon[STAFF_2].attack_down1,"hacktwo01");
	my_strcp(actors_defs[orchan_female].weapon[STAFF_2].attack_down2,"hacktwo01");
	actors_defs[orchan_female].weapon[STAFF_2].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_female].weapon[STAFF_3].model_name,"./md2/staff2_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[STAFF_3].skin_name,"./md2/staff3.bmp");
	my_strcp(actors_defs[orchan_female].weapon[STAFF_3].attack_up1,"slashtwo01");
	my_strcp(actors_defs[orchan_female].weapon[STAFF_3].attack_up2,"slashtwo01");
	my_strcp(actors_defs[orchan_female].weapon[STAFF_3].attack_down1,"hacktwo01");
	my_strcp(actors_defs[orchan_female].weapon[STAFF_3].attack_down2,"hacktwo01");
	actors_defs[orchan_female].weapon[STAFF_3].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_female].weapon[STAFF_4].model_name,"./md2/staff3_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[STAFF_4].skin_name,"./md2/staff4.bmp");
	my_strcp(actors_defs[orchan_female].weapon[STAFF_4].attack_up1,"slashtwo01");
	my_strcp(actors_defs[orchan_female].weapon[STAFF_4].attack_up2,"slashtwo01");
	my_strcp(actors_defs[orchan_female].weapon[STAFF_4].attack_down1,"hacktwo01");
	my_strcp(actors_defs[orchan_female].weapon[STAFF_4].attack_down2,"hacktwo01");
	actors_defs[orchan_female].weapon[STAFF_4].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_female].weapon[HAMMER_1].model_name,"./md2/warhammer1_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[HAMMER_1].skin_name,"./md2/warhammer1.bmp");
	my_strcp(actors_defs[orchan_female].weapon[HAMMER_1].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[HAMMER_1].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[HAMMER_1].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[HAMMER_1].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[HAMMER_1].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_female].weapon[HAMMER_2].model_name,"./md2/warhammer2_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[HAMMER_2].skin_name,"./md2/warhammer2.bmp");
	my_strcp(actors_defs[orchan_female].weapon[HAMMER_2].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[HAMMER_2].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[HAMMER_2].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[HAMMER_2].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[HAMMER_2].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_female].weapon[PICKAX].model_name,"./md2/pickaxe1_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[PICKAX].skin_name,"./md2/pickaxe1.bmp");
	my_strcp(actors_defs[orchan_female].weapon[PICKAX].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[PICKAX].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[PICKAX].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[PICKAX].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[PICKAX].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_female].weapon[PICKAX_MAGIC].model_name,"./md2/pickaxe1_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[PICKAX_MAGIC].skin_name,"./md2/pickaxe1.bmp");
	my_strcp(actors_defs[orchan_female].weapon[PICKAX_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[PICKAX_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[PICKAX_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[PICKAX_MAGIC].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[PICKAX_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_IRON].model_name,"./md2/axe1_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_IRON].skin_name,"./md2/axe1.bmp");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_IRON].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_IRON].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_IRON].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_IRON].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[BATTLEAXE_IRON].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_STEEL].model_name,"./md2/axe2_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_STEEL].skin_name,"./md2/axe2.bmp");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_STEEL].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_STEEL].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_STEEL].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_STEEL].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[BATTLEAXE_STEEL].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM].model_name,"./md2/axe3_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM].skin_name,"./md2/axe3.bmp");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_IRON_FIRE].model_name,"./md2/axe1_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_IRON_FIRE].skin_name,"./md2/axe1.bmp");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_IRON_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_IRON_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_IRON_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_IRON_FIRE].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[BATTLEAXE_IRON_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_STEEL_FIRE].model_name,"./md2/axe2_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_STEEL_FIRE].skin_name,"./md2/axe2.bmp");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_STEEL_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_STEEL_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_STEEL_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_STEEL_FIRE].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[BATTLEAXE_STEEL_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_STEEL_COLD].model_name,"./md2/axe2_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_STEEL_COLD].skin_name,"./md2/axe2.bmp");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_STEEL_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_STEEL_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_STEEL_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_STEEL_COLD].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[BATTLEAXE_STEEL_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM_FIRE].model_name,"./md2/axe3_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM_FIRE].skin_name,"./md2/axe3.bmp");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM_FIRE].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM_COLD].model_name,"./md2/axe3_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM_COLD].skin_name,"./md2/axe3.bmp");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM_COLD].attack_down2,"hackone01");
	actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM_MAGIC].model_name,"./md2/axe3_tall.md2");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM_MAGIC].skin_name,"./md2/axe3.bmp");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_female].weapon[BATTLEAXE_TITANIUM_MAGIC].attack_down1,"hackone01");
	...
	actors_defs[orchan_female].run_speed=2.0/18;

	//////////////////////////////////////////////////////////////////////////////////////////
	/////////////////////////////////////////////////////////////////////////////
	actors_defs[orchan_male].ghost=0;
	my_strcp(actors_defs[orchan_male].skin_name,"./md2/orchan_male.bmp");
	my_strcp(actors_defs[orchan_male].file_name,"./md2/orchan_male.md2");
	my_strcp(actors_defs[orchan_male].walk_frame,"walk01");
	my_strcp(actors_defs[orchan_male].run_frame,"run01");
	my_strcp(actors_defs[orchan_male].die1_frame,"dief01");
	my_strcp(actors_defs[orchan_male].die2_frame,"dieb11");
	my_strcp(actors_defs[orchan_male].pain1_frame,"pain01");
	my_strcp(actors_defs[orchan_male].pick_frame,"pickup01");
	my_strcp(actors_defs[orchan_male].drop_frame,"drop01");
	my_strcp(actors_defs[orchan_male].idle_frame,"idle01");
	my_strcp(actors_defs[orchan_male].idle_sit_frame,"sitidle01");
	my_strcp(actors_defs[orchan_male].harvest_frame,"harvest01");
	my_strcp(actors_defs[orchan_male].attack_cast_frame,"cast01");
	my_strcp(actors_defs[orchan_male].sit_down_frame,"intosit01");
	my_strcp(actors_defs[orchan_male].stand_up_frame,"outsit01");
	my_strcp(actors_defs[orchan_male].in_combat_frame,"intofight01");
	my_strcp(actors_defs[orchan_male].out_combat_frame,"outfight01");
	my_strcp(actors_defs[orchan_male].combat_idle_frame,"fightidle01");

	my_strcp(actors_defs[orchan_male].shirt[SHIRT_BLACK].arms_name,"./md2/arms1_black.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_BLACK].model_name,"./md2/torso1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_BLACK].torso_name,"./md2/torso1_black.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_BLUE].arms_name,"./md2/arms1_blue.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_BLUE].model_name,"./md2/torso1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_BLUE].torso_name,"./md2/torso1_blue.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_BROWN].arms_name,"./md2/arms1_brown.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_BROWN].model_name,"./md2/torso1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_BROWN].torso_name,"./md2/torso1_brown.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_GREY].arms_name,"./md2/arms1_gray.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_GREY].model_name,"./md2/torso1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_GREY].torso_name,"./md2/torso1_gray.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_GREEN].arms_name,"./md2/arms1_green.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_GREEN].model_name,"./md2/torso1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_GREEN].torso_name,"./md2/torso1_green.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_LIGHTBROWN].arms_name,"./md2/arms1_lightbrown.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_LIGHTBROWN].model_name,"./md2/torso1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_LIGHTBROWN].torso_name,"./md2/torso1_lightbrown.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_ORANGE].arms_name,"./md2/arms1_orange.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_ORANGE].model_name,"./md2/torso1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_ORANGE].torso_name,"./md2/torso1_orange.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_PINK].arms_name,"./md2/arms1_pink.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_PINK].model_name,"./md2/torso1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_PINK].torso_name,"./md2/torso1_pink.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_PURPLE].arms_name,"./md2/arms1_purple.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_PURPLE].model_name,"./md2/torso1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_PURPLE].torso_name,"./md2/torso1_purple.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_RED].arms_name,"./md2/arms1_red.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_RED].model_name,"./md2/torso1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_RED].torso_name,"./md2/torso1_red.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_WHITE].arms_name,"./md2/arms1_white.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_WHITE].model_name,"./md2/torso1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_WHITE].torso_name,"./md2/torso1_white.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_YELLOW].arms_name,"./md2/arms1_yellow.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_YELLOW].model_name,"./md2/torso1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_YELLOW].torso_name,"./md2/torso1_yellow.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_LEATHER_ARMOR].arms_name,"./md2/arms2.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_LEATHER_ARMOR].model_name,"./md2/torso1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_LEATHER_ARMOR].torso_name,"./md2/torso2.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_CHAIN_ARMOR].arms_name,"./md2/arms3.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_CHAIN_ARMOR].model_name,"./md2/torso1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_CHAIN_ARMOR].torso_name,"./md2/torso3.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_STEEL_CHAIN_ARMOR].arms_name,"./md2/arms4.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_STEEL_CHAIN_ARMOR].model_name,"./md2/torso1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_STEEL_CHAIN_ARMOR].torso_name,"./md2/torso4.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_TITANIUM_CHAIN_ARMOR].arms_name,"./md2/arms5.bmp");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_TITANIUM_CHAIN_ARMOR].model_name,"./md2/torso1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].shirt[SHIRT_TITANIUM_CHAIN_ARMOR].torso_name,"./md2/torso5.bmp");

	my_strcp(actors_defs[orchan_male].shirt[SHIRT_IRON_PLATE_ARMOR].arms_name,"./md2/arms6.bmp");
	...
	my_strcp(actors_defs[orchan_male].skin[SKIN_NORMAL].head_name,"./md2/head_orchanmgreen.bmp");
	my_strcp(actors_defs[orchan_male].skin[SKIN_PALE].hands_name,"./md2/hands_orchanpurple.bmp");
	my_strcp(actors_defs[orchan_male].skin[SKIN_PALE].head_name,"./md2/head_orchanmpurple.bmp");
	my_strcp(actors_defs[orchan_male].skin[SKIN_TAN].hands_name,"./md2/hands_tan.bmp");
	my_strcp(actors_defs[orchan_male].skin[SKIN_TAN].head_name,"./md2/head_orchanmtan.bmp");

	my_strcp(actors_defs[orchan_male].hair[HAIR_BLACK].hair_name,"./md2/hair_black.bmp");
	my_strcp(actors_defs[orchan_male].hair[HAIR_BLOND].hair_name,"./md2/hair_blond.bmp");
	my_strcp(actors_defs[orchan_male].hair[HAIR_BROWN].hair_name,"./md2/hair_brown.bmp");
	my_strcp(actors_defs[orchan_male].hair[HAIR_GRAY].hair_name,"./md2/hair_gray.bmp");
	my_strcp(actors_defs[orchan_male].hair[HAIR_RED].hair_name,"./md2/hair_red.bmp");
	my_strcp(actors_defs[orchan_male].hair[HAIR_WHITE].hair_name,"./md2/hair_white.bmp");

	my_strcp(actors_defs[orchan_male].boots[BOOTS_BLACK].boots_name,"./md2/boots1_black.bmp");
	my_strcp(actors_defs[orchan_male].boots[BOOTS_BROWN].boots_name,"./md2/boots1_brown.bmp");
	my_strcp(actors_defs[orchan_male].boots[BOOTS_DARKBROWN].boots_name,"./md2/boots1_darkbrown.bmp");
	my_strcp(actors_defs[orchan_male].boots[BOOTS_DULLBROWN].boots_name,"./md2/boots1_dullbrown.bmp");
	my_strcp(actors_defs[orchan_male].boots[BOOTS_LIGHTBROWN].boots_name,"./md2/boots1_lightbrown.bmp");
	my_strcp(actors_defs[orchan_male].boots[BOOTS_ORANGE].boots_name,"./md2/boots1_orange.bmp");
	my_strcp(actors_defs[orchan_male].boots[BOOTS_LEATHER].boots_name,"./md2/boots2.bmp");
	my_strcp(actors_defs[orchan_male].boots[BOOTS_FUR].boots_name,"./md2/boots3.bmp");
	my_strcp(actors_defs[orchan_male].boots[BOOTS_IRON_GREAVE].boots_name,"./md2/boots4.bmp");

	my_strcp(actors_defs[orchan_male].legs[PANTS_BLACK].legs_name,"./md2/pants1_black.bmp");
	my_strcp(actors_defs[orchan_male].legs[PANTS_BLACK].model_name,"./md2/legs1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].legs[PANTS_BLUE].legs_name,"./md2/pants1_blue.bmp");
	my_strcp(actors_defs[orchan_male].legs[PANTS_BLUE].model_name,"./md2/legs1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].legs[PANTS_BROWN].legs_name,"./md2/pants1_brown.bmp");
	my_strcp(actors_defs[orchan_male].legs[PANTS_BROWN].model_name,"./md2/legs1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].legs[PANTS_DARKBROWN].legs_name,"./md2/pants1_darkbrown.bmp");
	my_strcp(actors_defs[orchan_male].legs[PANTS_DARKBROWN].model_name,"./md2/legs1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].legs[PANTS_GREY].legs_name,"./md2/pants1_gray.bmp");
	my_strcp(actors_defs[orchan_male].legs[PANTS_GREY].model_name,"./md2/legs1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].legs[PANTS_GREEN].legs_name,"./md2/pants1_green.bmp");
	my_strcp(actors_defs[orchan_male].legs[PANTS_GREEN].model_name,"./md2/legs1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].legs[PANTS_LIGHTBROWN].legs_name,"./md2/pants1_lightbrown.bmp");
	my_strcp(actors_defs[orchan_male].legs[PANTS_LIGHTBROWN].model_name,"./md2/legs1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].legs[PANTS_RED].legs_name,"./md2/pants1_red.bmp");
	my_strcp(actors_defs[orchan_male].legs[PANTS_RED].model_name,"./md2/legs1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].legs[PANTS_WHITE].legs_name,"./md2/pants1_white.bmp");
	my_strcp(actors_defs[orchan_male].legs[PANTS_WHITE].model_name,"./md2/legs1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].legs[PANTS_LEATHER].legs_name,"./md2/pants2.bmp");
	my_strcp(actors_defs[orchan_male].legs[PANTS_LEATHER].model_name,"./md2/legs1_orchanm.md2");
	...
	my_strcp(actors_defs[orchan_male].cape[CAPE_BLUE].model_name,"./md2/cape1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].cape[CAPE_BLUE].skin_name,"./md2/cape1_blue.bmp");
	my_strcp(actors_defs[orchan_male].cape[CAPE_BLUEGRAY].model_name,"./md2/cape1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].cape[CAPE_BLUEGRAY].skin_name,"./md2/cape1_bluegray.bmp");
	my_strcp(actors_defs[orchan_male].cape[CAPE_BROWN].model_name,"./md2/cape1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].cape[CAPE_BROWN].skin_name,"./md2/cape1_brown.bmp");
	my_strcp(actors_defs[orchan_male].cape[CAPE_BROWNGRAY].model_name,"./md2/cape1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].cape[CAPE_BROWNGRAY].skin_name,"./md2/cape1_browngray.bmp");
	my_strcp(actors_defs[orchan_male].cape[CAPE_GRAY].model_name,"./md2/cape1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].cape[CAPE_GRAY].skin_name,"./md2/cape1_gray.bmp");
	my_strcp(actors_defs[orchan_male].cape[CAPE_GREEN].model_name,"./md2/cape1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].cape[CAPE_GREEN].skin_name,"./md2/cape1_green.bmp");
	my_strcp(actors_defs[orchan_male].cape[CAPE_GREENGRAY].model_name,"./md2/cape1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].cape[CAPE_GREENGRAY].skin_name,"./md2/cape1_greengray.bmp");
	my_strcp(actors_defs[orchan_male].cape[CAPE_PURPLE].model_name,"./md2/cape1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].cape[CAPE_PURPLE].skin_name,"./md2/cape1_purple.bmp");
	my_strcp(actors_defs[orchan_male].cape[CAPE_WHITE].model_name,"./md2/cape1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].cape[CAPE_WHITE].skin_name,"./md2/cape1_white.bmp");
	my_strcp(actors_defs[orchan_male].cape[CAPE_GOLD].model_name,"./md2/cape1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].cape[CAPE_GOLD].skin_name,"./md2/cape1_gold.bmp");
	my_strcp(actors_defs[orchan_male].cape[CAPE_RED].model_name,"./md2/cape1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].cape[CAPE_RED].skin_name,"./md2/cape1_red.bmp");
	my_strcp(actors_defs[orchan_male].cape[CAPE_ORANGE].model_name,"./md2/cape1_orchanm.md2");
	...
	my_strcp(actors_defs[orchan_male].cape[CAPE_QUELL].model_name,"./md2/cape1_orchanm.md2");
	my_strcp(actors_defs[orchan_male].cape[CAPE_QUELL].skin_name,"./md2/cape_quell.bmp");
	...
	my_strcp(actors_defs[orchan_male].head[HEAD_3].model_name,"./md2/head3_orchanm.md2");
	my_strcp(actors_defs[orchan_male].head[HEAD_4].model_name,"./md2/head4_orchanm.md2");
	my_strcp(actors_defs[orchan_male].head[HEAD_5].model_name,"./md2/head1_orchanm.md2");

	my_strcp(actors_defs[orchan_male].shield[SHIELD_WOOD].model_name,"./md2/shield1_tall.md2");
	my_strcp(actors_defs[orchan_male].shield[SHIELD_WOOD].skin_name,"./md2/shield1_wood1.bmp");
	my_strcp(actors_defs[orchan_male].shield[SHIELD_WOOD_ENHANCED].model_name,"./md2/shield1_tall.md2");
	my_strcp(actors_defs[orchan_male].shield[SHIELD_WOOD_ENHANCED].skin_name,"./md2/shield1_wood2.bmp");
	my_strcp(actors_defs[orchan_male].shield[SHIELD_IRON].model_name,"./md2/shield1_tall.md2");
	my_strcp(actors_defs[orchan_male].shield[SHIELD_IRON].skin_name,"./md2/shield1_iron.bmp");
	my_strcp(actors_defs[orchan_male].shield[SHIELD_STEEL].model_name,"./md2/shield1_tall.md2");
	my_strcp(actors_defs[orchan_male].shield[SHIELD_STEEL].skin_name,"./md2/shield1_steel.bmp");


	my_strcp(actors_defs[orchan_male].weapon[WEAPON_NONE].model_name,none);
	my_strcp(actors_defs[orchan_male].weapon[WEAPON_NONE].skin_name,none);
	my_strcp(actors_defs[orchan_male].weapon[WEAPON_NONE].attack_up1,"punchone01");
	my_strcp(actors_defs[orchan_male].weapon[WEAPON_NONE].attack_up2,"punchtwo01");
	my_strcp(actors_defs[orchan_male].weapon[WEAPON_NONE].attack_down1,"kickone01");
	my_strcp(actors_defs[orchan_male].weapon[WEAPON_NONE].attack_down2,"kicktwo01");

	my_strcp(actors_defs[orchan_male].weapon[GLOVE_FUR].model_name,none);
	my_strcp(actors_defs[orchan_male].weapon[GLOVE_FUR].skin_name,"./md2/gloves_fur.bmp");
	my_strcp(actors_defs[orchan_male].weapon[GLOVE_FUR].attack_up1,"punchone01");
	my_strcp(actors_defs[orchan_male].weapon[GLOVE_FUR].attack_up2,"punchtwo01");
	my_strcp(actors_defs[orchan_male].weapon[GLOVE_FUR].attack_down1,"kickone01");
	my_strcp(actors_defs[orchan_male].weapon[GLOVE_FUR].attack_down2,"kicktwo01");
	actors_defs[orchan_male].weapon[GLOVE_FUR].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_male].weapon[GLOVE_LEATHER].model_name,none);
	my_strcp(actors_defs[orchan_male].weapon[GLOVE_LEATHER].skin_name,"./md2/gloves_leather.bmp");
	my_strcp(actors_defs[orchan_male].weapon[GLOVE_LEATHER].attack_up1,"punchone01");
	my_strcp(actors_defs[orchan_male].weapon[GLOVE_LEATHER].attack_up2,"punchtwo01");
	my_strcp(actors_defs[orchan_male].weapon[GLOVE_LEATHER].attack_down1,"kickone01");
	my_strcp(actors_defs[orchan_male].weapon[GLOVE_LEATHER].attack_down2,"kicktwo01");
	actors_defs[orchan_male].weapon[GLOVE_LEATHER].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_1].model_name,"./md2/sword1_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_1].skin_name,"./md2/sword1.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_1].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_1].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_1].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_1].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_1].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_1_FIRE].model_name,"./md2/sword1_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_1_FIRE].skin_name,"./md2/sword1.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_1_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_1_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_1_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_1_FIRE].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_1_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_2].model_name,"./md2/sword2_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_2].skin_name,"./md2/sword2.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_2].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_2].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_2].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_2].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_2].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_2_FIRE].model_name,"./md2/sword2_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_2_FIRE].skin_name,"./md2/sword2.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_2_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_2_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_2_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_2_FIRE].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_2_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_2_COLD].model_name,"./md2/sword2_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_2_COLD].skin_name,"./md2/sword2.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_2_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_2_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_2_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_2_COLD].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_2_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_3].model_name,"./md2/sword3_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_3].skin_name,"./md2/sword3.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_3].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_3].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_3].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_3].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_3].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_3_FIRE].model_name,"./md2/sword3_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_3_FIRE].skin_name,"./md2/sword3.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_3_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_3_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_3_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_3_FIRE].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_3_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_3_COLD].model_name,"./md2/sword3_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_3_COLD].skin_name,"./md2/sword3.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_3_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_3_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_3_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_3_COLD].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_3_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_3_MAGIC].model_name,"./md2/sword3_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_3_MAGIC].skin_name,"./md2/sword3.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_3_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_3_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_3_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_3_MAGIC].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_3_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_4].model_name,"./md2/sword4_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4].skin_name,"./md2/sword4.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_4].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_FIRE].model_name,"./md2/sword4_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_FIRE].skin_name,"./md2/sword4.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_FIRE].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_4_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_COLD].model_name,"./md2/sword4_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_COLD].skin_name,"./md2/sword4.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_COLD].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_4_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_MAGIC].model_name,"./md2/sword4_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_MAGIC].skin_name,"./md2/sword4.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_MAGIC].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_4_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_THERMAL].model_name,"./md2/sword4_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_THERMAL].skin_name,"./md2/sword4.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_THERMAL].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_THERMAL].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_THERMAL].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_4_THERMAL].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_4_THERMAL].glow=GLOW_THERMAL;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_5].model_name,"./md2/sword5_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5].skin_name,"./md2/sword5.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_5].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_FIRE].model_name,"./md2/sword5_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_FIRE].skin_name,"./md2/sword5.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_FIRE].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_5_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_COLD].model_name,"./md2/sword5_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_COLD].skin_name,"./md2/sword5.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_COLD].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_5_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_MAGIC].model_name,"./md2/sword5_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_MAGIC].skin_name,"./md2/sword5.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_MAGIC].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_5_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_THERMAL].model_name,"./md2/sword5_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_THERMAL].skin_name,"./md2/sword5.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_THERMAL].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_THERMAL].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_THERMAL].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_5_THERMAL].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_5_THERMAL].glow=GLOW_THERMAL;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_6].model_name,"./md2/sword6_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6].skin_name,"./md2/sword6.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_6].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_FIRE].model_name,"./md2/sword6_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_FIRE].skin_name,"./md2/sword6.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_FIRE].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_6_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_COLD].model_name,"./md2/sword6_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_COLD].skin_name,"./md2/sword6.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_COLD].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_6_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_MAGIC].model_name,"./md2/sword6_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_MAGIC].skin_name,"./md2/sword6.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_MAGIC].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_6_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_THERMAL].model_name,"./md2/sword6_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_THERMAL].skin_name,"./md2/sword6.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_THERMAL].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_THERMAL].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_THERMAL].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_6_THERMAL].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_6_THERMAL].glow=GLOW_THERMAL;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_7].model_name,"./md2/sword7_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7].skin_name,"./md2/sword7.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_7].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_FIRE].model_name,"./md2/sword7_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_FIRE].skin_name,"./md2/sword7.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_FIRE].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_7_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_COLD].model_name,"./md2/sword7_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_COLD].skin_name,"./md2/sword7.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_COLD].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_7_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_MAGIC].model_name,"./md2/sword7_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_MAGIC].skin_name,"./md2/sword7.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_MAGIC].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_7_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_THERMAL].model_name,"./md2/sword7_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_THERMAL].skin_name,"./md2/sword7.bmp");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_THERMAL].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_THERMAL].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_THERMAL].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[SWORD_7_THERMAL].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[SWORD_7_THERMAL].glow=GLOW_THERMAL;

	my_strcp(actors_defs[orchan_male].weapon[STAFF_1].model_name,"./md2/staff1_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[STAFF_1].skin_name,"./md2/staff1_brown.bmp");
	my_strcp(actors_defs[orchan_male].weapon[STAFF_1].attack_up1,"slashtwo01");
	my_strcp(actors_defs[orchan_male].weapon[STAFF_1].attack_up2,"slashtwo01");
	my_strcp(actors_defs[orchan_male].weapon[STAFF_1].attack_down1,"hacktwo01");
	my_strcp(actors_defs[orchan_male].weapon[STAFF_1].attack_down2,"hacktwo01");
	actors_defs[orchan_male].weapon[STAFF_1].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_male].weapon[STAFF_2].model_name,"./md2/staff1_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[STAFF_2].skin_name,"./md2/staff1_green.bmp");
	my_strcp(actors_defs[orchan_male].weapon[STAFF_2].attack_up1,"slashtwo01");
	my_strcp(actors_defs[orchan_male].weapon[STAFF_2].attack_up2,"slashtwo01");
	my_strcp(actors_defs[orchan_male].weapon[STAFF_2].attack_down1,"hacktwo01");
	my_strcp(actors_defs[orchan_male].weapon[STAFF_2].attack_down2,"hacktwo01");
	actors_defs[orchan_male].weapon[STAFF_2].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_male].weapon[STAFF_3].model_name,"./md2/staff2_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[STAFF_3].skin_name,"./md2/staff3.bmp");
	my_strcp(actors_defs[orchan_male].weapon[STAFF_3].attack_up1,"slashtwo01");
	my_strcp(actors_defs[orchan_male].weapon[STAFF_3].attack_up2,"slashtwo01");
	my_strcp(actors_defs[orchan_male].weapon[STAFF_3].attack_down1,"hacktwo01");
	my_strcp(actors_defs[orchan_male].weapon[STAFF_3].attack_down2,"hacktwo01");
	actors_defs[orchan_male].weapon[STAFF_3].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_male].weapon[STAFF_4].model_name,"./md2/staff3_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[STAFF_4].skin_name,"./md2/staff4.bmp");
	my_strcp(actors_defs[orchan_male].weapon[STAFF_4].attack_up1,"slashtwo01");
	my_strcp(actors_defs[orchan_male].weapon[STAFF_4].attack_up2,"slashtwo01");
	my_strcp(actors_defs[orchan_male].weapon[STAFF_4].attack_down1,"hacktwo01");
	my_strcp(actors_defs[orchan_male].weapon[STAFF_4].attack_down2,"hacktwo01");
	actors_defs[orchan_male].weapon[STAFF_4].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_male].weapon[HAMMER_1].model_name,"./md2/warhammer1_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[HAMMER_1].skin_name,"./md2/warhammer1.bmp");
	my_strcp(actors_defs[orchan_male].weapon[HAMMER_1].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[HAMMER_1].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[HAMMER_1].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[HAMMER_1].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[HAMMER_1].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_male].weapon[HAMMER_2].model_name,"./md2/warhammer2_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[HAMMER_2].skin_name,"./md2/warhammer2.bmp");
	my_strcp(actors_defs[orchan_male].weapon[HAMMER_2].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[HAMMER_2].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[HAMMER_2].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[HAMMER_2].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[HAMMER_2].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_male].weapon[PICKAX].model_name,"./md2/pickaxe1_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[PICKAX].skin_name,"./md2/pickaxe1.bmp");
	my_strcp(actors_defs[orchan_male].weapon[PICKAX].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[PICKAX].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[PICKAX].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[PICKAX].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[PICKAX].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_male].weapon[PICKAX_MAGIC].model_name,"./md2/pickaxe1_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[PICKAX_MAGIC].skin_name,"./md2/pickaxe1.bmp");
	my_strcp(actors_defs[orchan_male].weapon[PICKAX_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[PICKAX_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[PICKAX_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[PICKAX_MAGIC].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[PICKAX_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_IRON].model_name,"./md2/axe1_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_IRON].skin_name,"./md2/axe1.bmp");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_IRON].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_IRON].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_IRON].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_IRON].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[BATTLEAXE_IRON].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_STEEL].model_name,"./md2/axe2_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_STEEL].skin_name,"./md2/axe2.bmp");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_STEEL].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_STEEL].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_STEEL].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_STEEL].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[BATTLEAXE_STEEL].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM].model_name,"./md2/axe3_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM].skin_name,"./md2/axe3.bmp");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM].glow=GLOW_NONE;

	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_IRON_FIRE].model_name,"./md2/axe1_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_IRON_FIRE].skin_name,"./md2/axe1.bmp");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_IRON_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_IRON_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_IRON_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_IRON_FIRE].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[BATTLEAXE_IRON_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_STEEL_FIRE].model_name,"./md2/axe2_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_STEEL_FIRE].skin_name,"./md2/axe2.bmp");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_STEEL_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_STEEL_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_STEEL_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_STEEL_FIRE].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[BATTLEAXE_STEEL_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_STEEL_COLD].model_name,"./md2/axe2_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_STEEL_COLD].skin_name,"./md2/axe2.bmp");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_STEEL_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_STEEL_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_STEEL_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_STEEL_COLD].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[BATTLEAXE_STEEL_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM_FIRE].model_name,"./md2/axe3_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM_FIRE].skin_name,"./md2/axe3.bmp");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM_FIRE].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM_COLD].model_name,"./md2/axe3_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM_COLD].skin_name,"./md2/axe3.bmp");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM_COLD].attack_down2,"hackone01");
	actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM_MAGIC].model_name,"./md2/axe3_tall.md2");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM_MAGIC].skin_name,"./md2/axe3.bmp");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[orchan_male].weapon[BATTLEAXE_TITANIUM_MAGIC].attack_down1,"hackone01");
	...
	actors_defs[orchan_male].run_speed=2.0/18;

	//////////////////////////////////////////////////////////////////////////////////////////
	/////////////////////////////////////////////////////////////////////////////
	actors_defs[draegoni_female].ghost=0;
	my_strcp(actors_defs[draegoni_female].skin_name,"./md2/draegoni_female.bmp");
	my_strcp(actors_defs[draegoni_female].file_name,"./md2/draegoni_female.md2");
	my_strcp(actors_defs[draegoni_female].walk_frame,"walk01");
	my_strcp(actors_defs[draegoni_female].run_frame,"run01");
	my_strcp(actors_defs[draegoni_female].die1_frame,"dief01");
	my_strcp(actors_defs[draegoni_female].die2_frame,"dieb11");
	my_strcp(actors_defs[draegoni_female].pain1_frame,"pain01");
	my_strcp(actors_defs[draegoni_female].pick_frame,"pickup01");
	my_strcp(actors_defs[draegoni_female].drop_frame,"drop01");
	my_strcp(actors_defs[draegoni_female].idle_frame,"idle01");
	my_strcp(actors_defs[draegoni_female].idle_sit_frame,"sitidle01");
	my_strcp(actors_defs[draegoni_female].harvest_frame,"harvest01");
	my_strcp(actors_defs[draegoni_female].attack_cast_frame,"cast01");
	my_strcp(actors_defs[draegoni_female].sit_down_frame,"intosit01");
	my_strcp(actors_defs[draegoni_female].stand_up_frame,"outsit01");
	my_strcp(actors_defs[draegoni_female].in_combat_frame,"intofight01");
	my_strcp(actors_defs[draegoni_female].out_combat_frame,"outfight01");
	my_strcp(actors_defs[draegoni_female].combat_idle_frame,"fightidle01");

	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_BLACK].arms_name,"./md2/arms1_black.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_BLACK].model_name,"./md2/torso1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_BLACK].torso_name,"./md2/torso1_black.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_BLUE].arms_name,"./md2/arms1_blue.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_BLUE].model_name,"./md2/torso1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_BLUE].torso_name,"./md2/torso1_blue.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_BROWN].arms_name,"./md2/arms1_brown.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_BROWN].model_name,"./md2/torso1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_BROWN].torso_name,"./md2/torso1_brown.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_GREY].arms_name,"./md2/arms1_gray.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_GREY].model_name,"./md2/torso1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_GREY].torso_name,"./md2/torso1_gray.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_GREEN].arms_name,"./md2/arms1_green.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_GREEN].model_name,"./md2/torso1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_GREEN].torso_name,"./md2/torso1_green.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_LIGHTBROWN].arms_name,"./md2/arms1_lightbrown.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_LIGHTBROWN].model_name,"./md2/torso1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_LIGHTBROWN].torso_name,"./md2/torso1_lightbrown.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_ORANGE].arms_name,"./md2/arms1_orange.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_ORANGE].model_name,"./md2/torso1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_ORANGE].torso_name,"./md2/torso1_orange.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_PINK].arms_name,"./md2/arms1_pink.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_PINK].model_name,"./md2/torso1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_PINK].torso_name,"./md2/torso1_pink.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_PURPLE].arms_name,"./md2/arms1_purple.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_PURPLE].model_name,"./md2/torso1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_PURPLE].torso_name,"./md2/torso1_purple.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_RED].arms_name,"./md2/arms1_red.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_RED].model_name,"./md2/torso1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_RED].torso_name,"./md2/torso1_red.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_WHITE].arms_name,"./md2/arms1_white.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_WHITE].model_name,"./md2/torso1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_WHITE].torso_name,"./md2/torso1_white.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_YELLOW].arms_name,"./md2/arms1_yellow.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_YELLOW].model_name,"./md2/torso1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_YELLOW].torso_name,"./md2/torso1_yellow.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_LEATHER_ARMOR].arms_name,"./md2/arms2.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_LEATHER_ARMOR].model_name,"./md2/torso1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_LEATHER_ARMOR].torso_name,"./md2/torso2.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_CHAIN_ARMOR].arms_name,"./md2/arms3.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_CHAIN_ARMOR].model_name,"./md2/torso1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_CHAIN_ARMOR].torso_name,"./md2/torso3.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_STEEL_CHAIN_ARMOR].arms_name,"./md2/arms4.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_STEEL_CHAIN_ARMOR].model_name,"./md2/torso1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_STEEL_CHAIN_ARMOR].torso_name,"./md2/torso4.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_TITANIUM_CHAIN_ARMOR].arms_name,"./md2/arms5.bmp");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_TITANIUM_CHAIN_ARMOR].model_name,"./md2/torso1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_TITANIUM_CHAIN_ARMOR].torso_name,"./md2/torso5.bmp");

	my_strcp(actors_defs[draegoni_female].shirt[SHIRT_IRON_PLATE_ARMOR].arms_name,"./md2/arms6.bmp");
	...
	my_strcp(actors_defs[draegoni_female].skin[SKIN_NORMAL].head_name,"./md2/head_draegonifgreen.bmp");
	my_strcp(actors_defs[draegoni_female].skin[SKIN_PALE].hands_name,"./md2/hands_draegonipurple.bmp");
	my_strcp(actors_defs[draegoni_female].skin[SKIN_PALE].head_name,"./md2/head_draegonifpurple.bmp");
	my_strcp(actors_defs[draegoni_female].skin[SKIN_TAN].hands_name,"./md2/hands_draegonired.bmp");
	my_strcp(actors_defs[draegoni_female].skin[SKIN_TAN].head_name,"./md2/head_draegonifred.bmp");

	my_strcp(actors_defs[draegoni_female].hair[HAIR_BLACK].hair_name,"./md2/hair_black.bmp");
	my_strcp(actors_defs[draegoni_female].hair[HAIR_BLOND].hair_name,"./md2/hair_blond.bmp");
	my_strcp(actors_defs[draegoni_female].hair[HAIR_BROWN].hair_name,"./md2/hair_brown.bmp");
	my_strcp(actors_defs[draegoni_female].hair[HAIR_GRAY].hair_name,"./md2/hair_gray.bmp");
	my_strcp(actors_defs[draegoni_female].hair[HAIR_RED].hair_name,"./md2/hair_red.bmp");
	my_strcp(actors_defs[draegoni_female].hair[HAIR_WHITE].hair_name,"./md2/hair_white.bmp");
	my_strcp(actors_defs[draegoni_female].hair[HAIR_BLUE].hair_name,"./md2/hair_draegoniblue.bmp");
	my_strcp(actors_defs[draegoni_female].hair[HAIR_GREEN].hair_name,"./md2/hair_draegonigreen.bmp");
	my_strcp(actors_defs[draegoni_female].hair[HAIR_PURPLE].hair_name,"./md2/hair_draegonipurple.bmp");

	my_strcp(actors_defs[draegoni_female].boots[BOOTS_BLACK].boots_name,"./md2/boots1_black.bmp");
	my_strcp(actors_defs[draegoni_female].boots[BOOTS_BROWN].boots_name,"./md2/boots1_brown.bmp");
	my_strcp(actors_defs[draegoni_female].boots[BOOTS_DARKBROWN].boots_name,"./md2/boots1_darkbrown.bmp");
	my_strcp(actors_defs[draegoni_female].boots[BOOTS_DULLBROWN].boots_name,"./md2/boots1_dullbrown.bmp");
	my_strcp(actors_defs[draegoni_female].boots[BOOTS_LIGHTBROWN].boots_name,"./md2/boots1_lightbrown.bmp");
	my_strcp(actors_defs[draegoni_female].boots[BOOTS_ORANGE].boots_name,"./md2/boots1_orange.bmp");
	my_strcp(actors_defs[draegoni_female].boots[BOOTS_LEATHER].boots_name,"./md2/boots2.bmp");
	my_strcp(actors_defs[draegoni_female].boots[BOOTS_FUR].boots_name,"./md2/boots3.bmp");
	my_strcp(actors_defs[draegoni_female].boots[BOOTS_IRON_GREAVE].boots_name,"./md2/boots4.bmp");

	my_strcp(actors_defs[draegoni_female].legs[PANTS_BLACK].legs_name,"./md2/pants1_black.bmp");
	my_strcp(actors_defs[draegoni_female].legs[PANTS_BLACK].model_name,"./md2/legs1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].legs[PANTS_BLUE].legs_name,"./md2/pants1_blue.bmp");
	my_strcp(actors_defs[draegoni_female].legs[PANTS_BLUE].model_name,"./md2/legs1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].legs[PANTS_BROWN].legs_name,"./md2/pants1_brown.bmp");
	my_strcp(actors_defs[draegoni_female].legs[PANTS_BROWN].model_name,"./md2/legs1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].legs[PANTS_DARKBROWN].legs_name,"./md2/pants1_darkbrown.bmp");
	my_strcp(actors_defs[draegoni_female].legs[PANTS_DARKBROWN].model_name,"./md2/legs1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].legs[PANTS_GREY].legs_name,"./md2/pants1_gray.bmp");
	my_strcp(actors_defs[draegoni_female].legs[PANTS_GREY].model_name,"./md2/legs1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].legs[PANTS_GREEN].legs_name,"./md2/pants1_green.bmp");
	my_strcp(actors_defs[draegoni_female].legs[PANTS_GREEN].model_name,"./md2/legs1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].legs[PANTS_LIGHTBROWN].legs_name,"./md2/pants1_lightbrown.bmp");
	my_strcp(actors_defs[draegoni_female].legs[PANTS_LIGHTBROWN].model_name,"./md2/legs1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].legs[PANTS_RED].legs_name,"./md2/pants1_red.bmp");
	my_strcp(actors_defs[draegoni_female].legs[PANTS_RED].model_name,"./md2/legs1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].legs[PANTS_WHITE].legs_name,"./md2/pants1_white.bmp");
	my_strcp(actors_defs[draegoni_female].legs[PANTS_WHITE].model_name,"./md2/legs1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].legs[PANTS_LEATHER].legs_name,"./md2/pants2.bmp");
	my_strcp(actors_defs[draegoni_female].legs[PANTS_LEATHER].model_name,"./md2/legs1_draegonif.md2");
	...
	my_strcp(actors_defs[draegoni_female].cape[CAPE_BLUE].model_name,"./md2/cape1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_BLUE].skin_name,"./md2/cape1_blue.bmp");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_BLUEGRAY].model_name,"./md2/cape1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_BLUEGRAY].skin_name,"./md2/cape1_bluegray.bmp");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_BROWN].model_name,"./md2/cape1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_BROWN].skin_name,"./md2/cape1_brown.bmp");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_BROWNGRAY].model_name,"./md2/cape1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_BROWNGRAY].skin_name,"./md2/cape1_browngray.bmp");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_GRAY].model_name,"./md2/cape1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_GRAY].skin_name,"./md2/cape1_gray.bmp");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_GREEN].model_name,"./md2/cape1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_GREEN].skin_name,"./md2/cape1_green.bmp");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_GREENGRAY].model_name,"./md2/cape1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_GREENGRAY].skin_name,"./md2/cape1_greengray.bmp");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_PURPLE].model_name,"./md2/cape1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_PURPLE].skin_name,"./md2/cape1_purple.bmp");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_WHITE].model_name,"./md2/cape1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_WHITE].skin_name,"./md2/cape1_white.bmp");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_GOLD].model_name,"./md2/cape1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_GOLD].skin_name,"./md2/cape1_gold.bmp");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_RED].model_name,"./md2/cape1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_RED].skin_name,"./md2/cape1_red.bmp");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_ORANGE].model_name,"./md2/cape1_draegonif.md2");
	...
	my_strcp(actors_defs[draegoni_female].cape[CAPE_QUELL].model_name,"./md2/cape1_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].cape[CAPE_QUELL].skin_name,"./md2/cape_quell.bmp");
	...
	my_strcp(actors_defs[draegoni_female].head[HEAD_3].model_name,"./md2/head3_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].head[HEAD_4].model_name,"./md2/head4_draegonif.md2");
	my_strcp(actors_defs[draegoni_female].head[HEAD_5].model_name,"./md2/head1_draegonif.md2");

	my_strcp(actors_defs[draegoni_female].shield[SHIELD_WOOD].model_name,"./md2/shield1_tall.md2");
	my_strcp(actors_defs[draegoni_female].shield[SHIELD_WOOD].skin_name,"./md2/shield1_wood1.bmp");
	my_strcp(actors_defs[draegoni_female].shield[SHIELD_WOOD_ENHANCED].model_name,"./md2/shield1_tall.md2");
	my_strcp(actors_defs[draegoni_female].shield[SHIELD_WOOD_ENHANCED].skin_name,"./md2/shield1_wood2.bmp");
	my_strcp(actors_defs[draegoni_female].shield[SHIELD_IRON].model_name,"./md2/shield1_tall.md2");
	my_strcp(actors_defs[draegoni_female].shield[SHIELD_IRON].skin_name,"./md2/shield1_iron.bmp");
	my_strcp(actors_defs[draegoni_female].shield[SHIELD_STEEL].model_name,"./md2/shield1_tall.md2");
	my_strcp(actors_defs[draegoni_female].shield[SHIELD_STEEL].skin_name,"./md2/shield1_steel.bmp");


	my_strcp(actors_defs[draegoni_female].weapon[WEAPON_NONE].model_name,none);
	my_strcp(actors_defs[draegoni_female].weapon[WEAPON_NONE].skin_name,none);
	my_strcp(actors_defs[draegoni_female].weapon[WEAPON_NONE].attack_up1,"punchone01");
	my_strcp(actors_defs[draegoni_female].weapon[WEAPON_NONE].attack_up2,"punchtwo01");
	my_strcp(actors_defs[draegoni_female].weapon[WEAPON_NONE].attack_down1,"kickone01");
	my_strcp(actors_defs[draegoni_female].weapon[WEAPON_NONE].attack_down2,"kicktwo01");

	my_strcp(actors_defs[draegoni_female].weapon[GLOVE_FUR].model_name,none);
	my_strcp(actors_defs[draegoni_female].weapon[GLOVE_FUR].skin_name,"./md2/gloves_fur.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[GLOVE_FUR].attack_up1,"punchone01");
	my_strcp(actors_defs[draegoni_female].weapon[GLOVE_FUR].attack_up2,"punchtwo01");
	my_strcp(actors_defs[draegoni_female].weapon[GLOVE_FUR].attack_down1,"kickone01");
	my_strcp(actors_defs[draegoni_female].weapon[GLOVE_FUR].attack_down2,"kicktwo01");
	actors_defs[draegoni_female].weapon[GLOVE_FUR].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_female].weapon[GLOVE_LEATHER].model_name,none);
	my_strcp(actors_defs[draegoni_female].weapon[GLOVE_LEATHER].skin_name,"./md2/gloves_leather.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[GLOVE_LEATHER].attack_up1,"punchone01");
	my_strcp(actors_defs[draegoni_female].weapon[GLOVE_LEATHER].attack_up2,"punchtwo01");
	my_strcp(actors_defs[draegoni_female].weapon[GLOVE_LEATHER].attack_down1,"kickone01");
	my_strcp(actors_defs[draegoni_female].weapon[GLOVE_LEATHER].attack_down2,"kicktwo01");
	actors_defs[draegoni_female].weapon[GLOVE_LEATHER].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_1].model_name,"./md2/sword1_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_1].skin_name,"./md2/sword1.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_1].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_1].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_1].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_1].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_1].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_1_FIRE].model_name,"./md2/sword1_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_1_FIRE].skin_name,"./md2/sword1.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_1_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_1_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_1_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_1_FIRE].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_1_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_2].model_name,"./md2/sword2_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_2].skin_name,"./md2/sword2.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_2].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_2].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_2].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_2].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_2].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_2_FIRE].model_name,"./md2/sword2_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_2_FIRE].skin_name,"./md2/sword2.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_2_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_2_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_2_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_2_FIRE].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_2_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_2_COLD].model_name,"./md2/sword2_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_2_COLD].skin_name,"./md2/sword2.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_2_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_2_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_2_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_2_COLD].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_2_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3].model_name,"./md2/sword3_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3].skin_name,"./md2/sword3.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_3].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3_FIRE].model_name,"./md2/sword3_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3_FIRE].skin_name,"./md2/sword3.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3_FIRE].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_3_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3_COLD].model_name,"./md2/sword3_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3_COLD].skin_name,"./md2/sword3.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3_COLD].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_3_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3_MAGIC].model_name,"./md2/sword3_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3_MAGIC].skin_name,"./md2/sword3.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_3_MAGIC].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_3_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4].model_name,"./md2/sword4_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4].skin_name,"./md2/sword4.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_4].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_FIRE].model_name,"./md2/sword4_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_FIRE].skin_name,"./md2/sword4.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_FIRE].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_4_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_COLD].model_name,"./md2/sword4_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_COLD].skin_name,"./md2/sword4.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_COLD].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_4_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_MAGIC].model_name,"./md2/sword4_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_MAGIC].skin_name,"./md2/sword4.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_MAGIC].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_4_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_THERMAL].model_name,"./md2/sword4_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_THERMAL].skin_name,"./md2/sword4.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_THERMAL].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_THERMAL].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_THERMAL].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_4_THERMAL].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_4_THERMAL].glow=GLOW_THERMAL;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5].model_name,"./md2/sword5_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5].skin_name,"./md2/sword5.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_5].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_FIRE].model_name,"./md2/sword5_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_FIRE].skin_name,"./md2/sword5.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_FIRE].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_5_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_COLD].model_name,"./md2/sword5_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_COLD].skin_name,"./md2/sword5.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_COLD].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_5_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_MAGIC].model_name,"./md2/sword5_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_MAGIC].skin_name,"./md2/sword5.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_MAGIC].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_5_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_THERMAL].model_name,"./md2/sword5_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_THERMAL].skin_name,"./md2/sword5.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_THERMAL].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_THERMAL].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_THERMAL].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_5_THERMAL].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_5_THERMAL].glow=GLOW_THERMAL;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6].model_name,"./md2/sword6_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6].skin_name,"./md2/sword6.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_6].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_FIRE].model_name,"./md2/sword6_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_FIRE].skin_name,"./md2/sword6.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_FIRE].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_6_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_COLD].model_name,"./md2/sword6_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_COLD].skin_name,"./md2/sword6.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_COLD].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_6_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_MAGIC].model_name,"./md2/sword6_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_MAGIC].skin_name,"./md2/sword6.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_MAGIC].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_6_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_THERMAL].model_name,"./md2/sword6_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_THERMAL].skin_name,"./md2/sword6.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_THERMAL].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_THERMAL].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_THERMAL].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_6_THERMAL].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_6_THERMAL].glow=GLOW_THERMAL;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7].model_name,"./md2/sword7_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7].skin_name,"./md2/sword7.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_7].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_FIRE].model_name,"./md2/sword7_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_FIRE].skin_name,"./md2/sword7.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_FIRE].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_7_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_COLD].model_name,"./md2/sword7_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_COLD].skin_name,"./md2/sword7.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_COLD].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_7_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_MAGIC].model_name,"./md2/sword7_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_MAGIC].skin_name,"./md2/sword7.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_MAGIC].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_7_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_THERMAL].model_name,"./md2/sword7_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_THERMAL].skin_name,"./md2/sword7.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_THERMAL].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_THERMAL].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_THERMAL].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[SWORD_7_THERMAL].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[SWORD_7_THERMAL].glow=GLOW_THERMAL;

	my_strcp(actors_defs[draegoni_female].weapon[STAFF_1].model_name,"./md2/staff1_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[STAFF_1].skin_name,"./md2/staff1_brown.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[STAFF_1].attack_up1,"slashtwo01");
	my_strcp(actors_defs[draegoni_female].weapon[STAFF_1].attack_up2,"slashtwo01");
	my_strcp(actors_defs[draegoni_female].weapon[STAFF_1].attack_down1,"hacktwo01");
	my_strcp(actors_defs[draegoni_female].weapon[STAFF_1].attack_down2,"hacktwo01");
	actors_defs[draegoni_female].weapon[STAFF_1].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_female].weapon[STAFF_2].model_name,"./md2/staff1_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[STAFF_2].skin_name,"./md2/staff1_green.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[STAFF_2].attack_up1,"slashtwo01");
	my_strcp(actors_defs[draegoni_female].weapon[STAFF_2].attack_up2,"slashtwo01");
	my_strcp(actors_defs[draegoni_female].weapon[STAFF_2].attack_down1,"hacktwo01");
	my_strcp(actors_defs[draegoni_female].weapon[STAFF_2].attack_down2,"hacktwo01");
	actors_defs[draegoni_female].weapon[STAFF_2].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_female].weapon[STAFF_3].model_name,"./md2/staff2_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[STAFF_3].skin_name,"./md2/staff3.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[STAFF_3].attack_up1,"slashtwo01");
	my_strcp(actors_defs[draegoni_female].weapon[STAFF_3].attack_up2,"slashtwo01");
	my_strcp(actors_defs[draegoni_female].weapon[STAFF_3].attack_down1,"hacktwo01");
	my_strcp(actors_defs[draegoni_female].weapon[STAFF_3].attack_down2,"hacktwo01");
	actors_defs[draegoni_female].weapon[STAFF_3].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_female].weapon[STAFF_4].model_name,"./md2/staff3_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[STAFF_4].skin_name,"./md2/staff4.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[STAFF_4].attack_up1,"slashtwo01");
	my_strcp(actors_defs[draegoni_female].weapon[STAFF_4].attack_up2,"slashtwo01");
	my_strcp(actors_defs[draegoni_female].weapon[STAFF_4].attack_down1,"hacktwo01");
	my_strcp(actors_defs[draegoni_female].weapon[STAFF_4].attack_down2,"hacktwo01");
	actors_defs[draegoni_female].weapon[STAFF_4].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_female].weapon[HAMMER_1].model_name,"./md2/warhammer1_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[HAMMER_1].skin_name,"./md2/warhammer1.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[HAMMER_1].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[HAMMER_1].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[HAMMER_1].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[HAMMER_1].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[HAMMER_1].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_female].weapon[HAMMER_2].model_name,"./md2/warhammer2_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[HAMMER_2].skin_name,"./md2/warhammer2.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[HAMMER_2].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[HAMMER_2].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[HAMMER_2].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[HAMMER_2].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[HAMMER_2].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_female].weapon[PICKAX].model_name,"./md2/pickaxe1_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[PICKAX].skin_name,"./md2/pickaxe1.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[PICKAX].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[PICKAX].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[PICKAX].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[PICKAX].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[PICKAX].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_female].weapon[PICKAX_MAGIC].model_name,"./md2/pickaxe1_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[PICKAX_MAGIC].skin_name,"./md2/pickaxe1.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[PICKAX_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[PICKAX_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[PICKAX_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[PICKAX_MAGIC].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[PICKAX_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_IRON].model_name,"./md2/axe1_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_IRON].skin_name,"./md2/axe1.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_IRON].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_IRON].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_IRON].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_IRON].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[BATTLEAXE_IRON].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_STEEL].model_name,"./md2/axe2_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_STEEL].skin_name,"./md2/axe2.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_STEEL].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_STEEL].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_STEEL].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_STEEL].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[BATTLEAXE_STEEL].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM].model_name,"./md2/axe3_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM].skin_name,"./md2/axe3.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_IRON_FIRE].model_name,"./md2/axe1_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_IRON_FIRE].skin_name,"./md2/axe1.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_IRON_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_IRON_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_IRON_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_IRON_FIRE].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[BATTLEAXE_IRON_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_STEEL_FIRE].model_name,"./md2/axe2_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_STEEL_FIRE].skin_name,"./md2/axe2.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_STEEL_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_STEEL_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_STEEL_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_STEEL_FIRE].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[BATTLEAXE_STEEL_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_STEEL_COLD].model_name,"./md2/axe2_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_STEEL_COLD].skin_name,"./md2/axe2.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_STEEL_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_STEEL_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_STEEL_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_STEEL_COLD].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[BATTLEAXE_STEEL_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM_FIRE].model_name,"./md2/axe3_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM_FIRE].skin_name,"./md2/axe3.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM_FIRE].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM_COLD].model_name,"./md2/axe3_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM_COLD].skin_name,"./md2/axe3.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM_COLD].attack_down2,"hackone01");
	actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM_MAGIC].model_name,"./md2/axe3_tall.md2");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM_MAGIC].skin_name,"./md2/axe3.bmp");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_female].weapon[BATTLEAXE_TITANIUM_MAGIC].attack_down1,"hackone01");
	...
	actors_defs[draegoni_female].run_speed=2.0/18;

	/////////////////////////////////////////////////////////////////////////////
	actors_defs[draegoni_male].ghost=0;
	my_strcp(actors_defs[draegoni_male].skin_name,"./md2/draegoni_male.bmp");
	my_strcp(actors_defs[draegoni_male].file_name,"./md2/draegoni_male.md2");
	my_strcp(actors_defs[draegoni_male].walk_frame,"walk01");
	my_strcp(actors_defs[draegoni_male].run_frame,"run01");
	my_strcp(actors_defs[draegoni_male].die1_frame,"dief01");
	my_strcp(actors_defs[draegoni_male].die2_frame,"dieb11");
	my_strcp(actors_defs[draegoni_male].pain1_frame,"pain01");
	my_strcp(actors_defs[draegoni_male].pick_frame,"pickup01");
	my_strcp(actors_defs[draegoni_male].drop_frame,"drop01");
	my_strcp(actors_defs[draegoni_male].idle_frame,"idle01");
	my_strcp(actors_defs[draegoni_male].idle_sit_frame,"sitidle01");
	my_strcp(actors_defs[draegoni_male].harvest_frame,"harvest01");
	my_strcp(actors_defs[draegoni_male].attack_cast_frame,"cast01");
	my_strcp(actors_defs[draegoni_male].sit_down_frame,"intosit01");
	my_strcp(actors_defs[draegoni_male].stand_up_frame,"outsit01");
	my_strcp(actors_defs[draegoni_male].in_combat_frame,"intofight01");
	my_strcp(actors_defs[draegoni_male].out_combat_frame,"outfight01");
	my_strcp(actors_defs[draegoni_male].combat_idle_frame,"fightidle01");

	
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_BLACK].arms_name,"./md2/arms1_black.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_BLACK].model_name,"./md2/torso1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_BLACK].torso_name,"./md2/torso1_black.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_BLUE].arms_name,"./md2/arms1_blue.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_BLUE].model_name,"./md2/torso1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_BLUE].torso_name,"./md2/torso1_blue.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_BROWN].arms_name,"./md2/arms1_brown.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_BROWN].model_name,"./md2/torso1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_BROWN].torso_name,"./md2/torso1_brown.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_GREY].arms_name,"./md2/arms1_gray.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_GREY].model_name,"./md2/torso1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_GREY].torso_name,"./md2/torso1_gray.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_GREEN].arms_name,"./md2/arms1_green.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_GREEN].model_name,"./md2/torso1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_GREEN].torso_name,"./md2/torso1_green.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_LIGHTBROWN].arms_name,"./md2/arms1_lightbrown.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_LIGHTBROWN].model_name,"./md2/torso1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_LIGHTBROWN].torso_name,"./md2/torso1_lightbrown.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_ORANGE].arms_name,"./md2/arms1_orange.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_ORANGE].model_name,"./md2/torso1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_ORANGE].torso_name,"./md2/torso1_orange.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_ORANGE].model_name,"./md2/torso1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_ORANGE].torso_name,"./md2/torso1_orange.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_PINK].arms_name,"./md2/arms1_pink.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_PINK].model_name,"./md2/torso1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_PINK].torso_name,"./md2/torso1_pink.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_PURPLE].arms_name,"./md2/arms1_purple.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_PURPLE].model_name,"./md2/torso1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_PURPLE].torso_name,"./md2/torso1_purple.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_RED].arms_name,"./md2/arms1_red.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_RED].model_name,"./md2/torso1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_RED].torso_name,"./md2/torso1_red.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_WHITE].arms_name,"./md2/arms1_white.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_WHITE].model_name,"./md2/torso1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_WHITE].torso_name,"./md2/torso1_white.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_YELLOW].arms_name,"./md2/arms1_yellow.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_YELLOW].model_name,"./md2/torso1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_YELLOW].torso_name,"./md2/torso1_yellow.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_LEATHER_ARMOR].arms_name,"./md2/arms2.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_LEATHER_ARMOR].model_name,"./md2/torso1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_LEATHER_ARMOR].torso_name,"./md2/torso2.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_CHAIN_ARMOR].arms_name,"./md2/arms3.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_CHAIN_ARMOR].model_name,"./md2/torso1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_CHAIN_ARMOR].torso_name,"./md2/torso3.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_STEEL_CHAIN_ARMOR].arms_name,"./md2/arms4.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_STEEL_CHAIN_ARMOR].model_name,"./md2/torso1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_STEEL_CHAIN_ARMOR].torso_name,"./md2/torso4.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_TITANIUM_CHAIN_ARMOR].arms_name,"./md2/arms5.bmp");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_TITANIUM_CHAIN_ARMOR].model_name,"./md2/torso1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_TITANIUM_CHAIN_ARMOR].torso_name,"./md2/torso5.bmp");

	my_strcp(actors_defs[draegoni_male].shirt[SHIRT_IRON_PLATE_ARMOR].arms_name,"./md2/arms6.bmp");
	...
	my_strcp(actors_defs[draegoni_male].skin[SKIN_NORMAL].head_name,"./md2/head_draegonimgreen.bmp");
	my_strcp(actors_defs[draegoni_male].skin[SKIN_PALE].hands_name,"./md2/hands_draegonipurple.bmp");
	my_strcp(actors_defs[draegoni_male].skin[SKIN_PALE].head_name,"./md2/head_draegonimpurple.bmp");
	my_strcp(actors_defs[draegoni_male].skin[SKIN_TAN].hands_name,"./md2/hands_draegonired.bmp");
	my_strcp(actors_defs[draegoni_male].skin[SKIN_TAN].head_name,"./md2/head_draegonimred.bmp");

	my_strcp(actors_defs[draegoni_male].hair[HAIR_BLACK].hair_name,"./md2/hair_black.bmp");
	my_strcp(actors_defs[draegoni_male].hair[HAIR_BLOND].hair_name,"./md2/hair_blond.bmp");
	my_strcp(actors_defs[draegoni_male].hair[HAIR_BROWN].hair_name,"./md2/hair_brown.bmp");
	my_strcp(actors_defs[draegoni_male].hair[HAIR_GRAY].hair_name,"./md2/hair_gray.bmp");
	my_strcp(actors_defs[draegoni_male].hair[HAIR_RED].hair_name,"./md2/hair_red.bmp");
	my_strcp(actors_defs[draegoni_male].hair[HAIR_WHITE].hair_name,"./md2/hair_white.bmp");
	my_strcp(actors_defs[draegoni_male].hair[HAIR_BLUE].hair_name,"./md2/hair_draegoniblue.bmp");
	my_strcp(actors_defs[draegoni_male].hair[HAIR_GREEN].hair_name,"./md2/hair_draegonigreen.bmp");
	my_strcp(actors_defs[draegoni_male].hair[HAIR_PURPLE].hair_name,"./md2/hair_draegonipurple.bmp");

	my_strcp(actors_defs[draegoni_male].boots[BOOTS_BLACK].boots_name,"./md2/boots1_black.bmp");
	my_strcp(actors_defs[draegoni_male].boots[BOOTS_BROWN].boots_name,"./md2/boots1_brown.bmp");
	my_strcp(actors_defs[draegoni_male].boots[BOOTS_DARKBROWN].boots_name,"./md2/boots1_darkbrown.bmp");
	my_strcp(actors_defs[draegoni_male].boots[BOOTS_DULLBROWN].boots_name,"./md2/boots1_dullbrown.bmp");
	my_strcp(actors_defs[draegoni_male].boots[BOOTS_LIGHTBROWN].boots_name,"./md2/boots1_lightbrown.bmp");
	my_strcp(actors_defs[draegoni_male].boots[BOOTS_ORANGE].boots_name,"./md2/boots1_orange.bmp");
	my_strcp(actors_defs[draegoni_male].boots[BOOTS_LEATHER].boots_name,"./md2/boots2.bmp");
	my_strcp(actors_defs[draegoni_male].boots[BOOTS_FUR].boots_name,"./md2/boots3.bmp");
	my_strcp(actors_defs[draegoni_male].boots[BOOTS_IRON_GREAVE].boots_name,"./md2/boots4.bmp");

	my_strcp(actors_defs[draegoni_male].legs[PANTS_BLACK].legs_name,"./md2/pants1_black.bmp");
	my_strcp(actors_defs[draegoni_male].legs[PANTS_BLACK].model_name,"./md2/legs1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].legs[PANTS_BLUE].legs_name,"./md2/pants1_blue.bmp");
	my_strcp(actors_defs[draegoni_male].legs[PANTS_BLUE].model_name,"./md2/legs1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].legs[PANTS_BROWN].legs_name,"./md2/pants1_brown.bmp");
	my_strcp(actors_defs[draegoni_male].legs[PANTS_BROWN].model_name,"./md2/legs1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].legs[PANTS_DARKBROWN].legs_name,"./md2/pants1_darkbrown.bmp");
	my_strcp(actors_defs[draegoni_male].legs[PANTS_DARKBROWN].model_name,"./md2/legs1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].legs[PANTS_GREY].legs_name,"./md2/pants1_gray.bmp");
	my_strcp(actors_defs[draegoni_male].legs[PANTS_GREY].model_name,"./md2/legs1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].legs[PANTS_GREEN].legs_name,"./md2/pants1_green.bmp");
	my_strcp(actors_defs[draegoni_male].legs[PANTS_GREEN].model_name,"./md2/legs1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].legs[PANTS_LIGHTBROWN].legs_name,"./md2/pants1_lightbrown.bmp");
	my_strcp(actors_defs[draegoni_male].legs[PANTS_LIGHTBROWN].model_name,"./md2/legs1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].legs[PANTS_RED].legs_name,"./md2/pants1_red.bmp");
	my_strcp(actors_defs[draegoni_male].legs[PANTS_RED].model_name,"./md2/legs1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].legs[PANTS_WHITE].legs_name,"./md2/pants1_white.bmp");
	my_strcp(actors_defs[draegoni_male].legs[PANTS_WHITE].model_name,"./md2/legs1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].legs[PANTS_LEATHER].legs_name,"./md2/pants2.bmp");
	my_strcp(actors_defs[draegoni_male].legs[PANTS_LEATHER].model_name,"./md2/legs1_draegonim.md2");
	...
	my_strcp(actors_defs[draegoni_male].cape[CAPE_BLUE].model_name,"./md2/cape1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_BLUE].skin_name,"./md2/cape1_blue.bmp");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_BLUEGRAY].model_name,"./md2/cape1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_BLUEGRAY].skin_name,"./md2/cape1_bluegray.bmp");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_BROWN].model_name,"./md2/cape1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_BROWN].skin_name,"./md2/cape1_brown.bmp");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_BROWNGRAY].model_name,"./md2/cape1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_BROWNGRAY].skin_name,"./md2/cape1_browngray.bmp");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_GRAY].model_name,"./md2/cape1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_GRAY].skin_name,"./md2/cape1_gray.bmp");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_GREEN].model_name,"./md2/cape1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_GREEN].skin_name,"./md2/cape1_green.bmp");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_GREENGRAY].model_name,"./md2/cape1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_GREENGRAY].skin_name,"./md2/cape1_greengray.bmp");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_PURPLE].model_name,"./md2/cape1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_PURPLE].skin_name,"./md2/cape1_purple.bmp");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_WHITE].model_name,"./md2/cape1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_WHITE].skin_name,"./md2/cape1_white.bmp");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_GOLD].model_name,"./md2/cape1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_GOLD].skin_name,"./md2/cape1_gold.bmp");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_RED].model_name,"./md2/cape1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_RED].skin_name,"./md2/cape1_red.bmp");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_ORANGE].model_name,"./md2/cape1_draegonim.md2");
	...
	my_strcp(actors_defs[draegoni_male].cape[CAPE_QUELL].model_name,"./md2/cape1_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].cape[CAPE_QUELL].skin_name,"./md2/cape_quell.bmp");
	...
	my_strcp(actors_defs[draegoni_male].head[HEAD_3].model_name,"./md2/head3_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].head[HEAD_4].model_name,"./md2/head4_draegonim.md2");
	my_strcp(actors_defs[draegoni_male].head[HEAD_5].model_name,"./md2/head1_draegonim.md2");

	my_strcp(actors_defs[draegoni_male].shield[SHIELD_WOOD].model_name,"./md2/shield1_tall.md2");
	my_strcp(actors_defs[draegoni_male].shield[SHIELD_WOOD].skin_name,"./md2/shield1_wood1.bmp");
	my_strcp(actors_defs[draegoni_male].shield[SHIELD_WOOD_ENHANCED].model_name,"./md2/shield1_tall.md2");
	my_strcp(actors_defs[draegoni_male].shield[SHIELD_WOOD_ENHANCED].skin_name,"./md2/shield1_wood2.bmp");
	my_strcp(actors_defs[draegoni_male].shield[SHIELD_IRON].model_name,"./md2/shield1_tall.md2");
	my_strcp(actors_defs[draegoni_male].shield[SHIELD_IRON].skin_name,"./md2/shield1_iron.bmp");
	my_strcp(actors_defs[draegoni_male].shield[SHIELD_STEEL].model_name,"./md2/shield1_tall.md2");
	my_strcp(actors_defs[draegoni_male].shield[SHIELD_STEEL].skin_name,"./md2/shield1_steel.bmp");

	my_strcp(actors_defs[draegoni_male].weapon[WEAPON_NONE].model_name,none);
	my_strcp(actors_defs[draegoni_male].weapon[WEAPON_NONE].skin_name,none);
	my_strcp(actors_defs[draegoni_male].weapon[WEAPON_NONE].attack_up1,"punchone01");
	my_strcp(actors_defs[draegoni_male].weapon[WEAPON_NONE].attack_up2,"punchtwo01");
	my_strcp(actors_defs[draegoni_male].weapon[WEAPON_NONE].attack_down1,"kickone01");
	my_strcp(actors_defs[draegoni_male].weapon[WEAPON_NONE].attack_down2,"kicktwo01");

	my_strcp(actors_defs[draegoni_male].weapon[GLOVE_FUR].model_name,none);
	my_strcp(actors_defs[draegoni_male].weapon[GLOVE_FUR].skin_name,"./md2/gloves_fur.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[GLOVE_FUR].attack_up1,"punchone01");
	my_strcp(actors_defs[draegoni_male].weapon[GLOVE_FUR].attack_up2,"punchtwo01");
	my_strcp(actors_defs[draegoni_male].weapon[GLOVE_FUR].attack_down1,"kickone01");
	my_strcp(actors_defs[draegoni_male].weapon[GLOVE_FUR].attack_down2,"kicktwo01");
	actors_defs[draegoni_male].weapon[GLOVE_FUR].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_male].weapon[GLOVE_LEATHER].model_name,none);
	my_strcp(actors_defs[draegoni_male].weapon[GLOVE_LEATHER].skin_name,"./md2/gloves_leather.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[GLOVE_LEATHER].attack_up1,"punchone01");
	my_strcp(actors_defs[draegoni_male].weapon[GLOVE_LEATHER].attack_up2,"punchtwo01");
	my_strcp(actors_defs[draegoni_male].weapon[GLOVE_LEATHER].attack_down1,"kickone01");
	actors_defs[draegoni_male].weapon[GLOVE_LEATHER].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_1].model_name,"./md2/sword1_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_1].skin_name,"./md2/sword1.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_1].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_1].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_1].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_1].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_1].glow=GLOW_NONE;


	my_strcp(actors_defs[draegoni_male].weapon[SWORD_1_FIRE].model_name,"./md2/sword1_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_1_FIRE].skin_name,"./md2/sword1.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_1_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_1_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_1_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_1_FIRE].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_1_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_2].model_name,"./md2/sword2_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_2].skin_name,"./md2/sword2.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_2].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_2].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_2].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_2].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_2].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_2_FIRE].model_name,"./md2/sword2_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_2_FIRE].skin_name,"./md2/sword2.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_2_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_2_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_2_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_2_FIRE].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_2_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_2_COLD].model_name,"./md2/sword2_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_2_COLD].skin_name,"./md2/sword2.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_2_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_2_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_2_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_2_COLD].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_2_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3].model_name,"./md2/sword3_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3].skin_name,"./md2/sword3.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_3].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3_FIRE].model_name,"./md2/sword3_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3_FIRE].skin_name,"./md2/sword3.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3_FIRE].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_3_FIRE].glow=GLOW_FIRE;


	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3_COLD].model_name,"./md2/sword3_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3_COLD].skin_name,"./md2/sword3.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3_COLD].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_3_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3_MAGIC].model_name,"./md2/sword3_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3_MAGIC].skin_name,"./md2/sword3.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_3_MAGIC].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_3_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4].model_name,"./md2/sword4_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4].skin_name,"./md2/sword4.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_4].glow=GLOW_NONE;


	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_FIRE].model_name,"./md2/sword4_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_FIRE].skin_name,"./md2/sword4.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_FIRE].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_4_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_COLD].model_name,"./md2/sword4_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_COLD].skin_name,"./md2/sword4.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_COLD].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_4_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_MAGIC].model_name,"./md2/sword4_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_MAGIC].skin_name,"./md2/sword4.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_MAGIC].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_4_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_THERMAL].model_name,"./md2/sword4_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_THERMAL].skin_name,"./md2/sword4.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_THERMAL].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_THERMAL].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_THERMAL].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_4_THERMAL].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_4_THERMAL].glow=GLOW_THERMAL;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5].model_name,"./md2/sword5_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5].skin_name,"./md2/sword5.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_5].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_FIRE].model_name,"./md2/sword5_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_FIRE].skin_name,"./md2/sword5.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_FIRE].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_5_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_COLD].model_name,"./md2/sword5_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_COLD].skin_name,"./md2/sword5.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_COLD].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_5_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_MAGIC].model_name,"./md2/sword5_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_MAGIC].skin_name,"./md2/sword5.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_MAGIC].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_5_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_THERMAL].model_name,"./md2/sword5_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_THERMAL].skin_name,"./md2/sword5.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_THERMAL].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_THERMAL].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_THERMAL].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_5_THERMAL].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_5_THERMAL].glow=GLOW_THERMAL;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6].model_name,"./md2/sword6_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6].skin_name,"./md2/sword6.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_6].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_FIRE].model_name,"./md2/sword6_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_FIRE].skin_name,"./md2/sword6.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_FIRE].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_6_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_COLD].model_name,"./md2/sword6_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_COLD].skin_name,"./md2/sword6.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_COLD].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_6_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_MAGIC].model_name,"./md2/sword6_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_MAGIC].skin_name,"./md2/sword6.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_MAGIC].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_6_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_THERMAL].model_name,"./md2/sword6_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_THERMAL].skin_name,"./md2/sword6.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_THERMAL].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_THERMAL].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_THERMAL].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_6_THERMAL].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_6_THERMAL].glow=GLOW_THERMAL;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7].model_name,"./md2/sword7_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7].skin_name,"./md2/sword7.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_7].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_FIRE].model_name,"./md2/sword7_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_FIRE].skin_name,"./md2/sword7.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_FIRE].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_7_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_COLD].model_name,"./md2/sword7_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_COLD].skin_name,"./md2/sword7.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_COLD].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_7_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_MAGIC].model_name,"./md2/sword7_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_MAGIC].skin_name,"./md2/sword7.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_MAGIC].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_7_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_THERMAL].model_name,"./md2/sword7_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_THERMAL].skin_name,"./md2/sword7.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_THERMAL].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_THERMAL].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_THERMAL].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[SWORD_7_THERMAL].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[SWORD_7_THERMAL].glow=GLOW_THERMAL;

	my_strcp(actors_defs[draegoni_male].weapon[STAFF_1].model_name,"./md2/staff1_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[STAFF_1].skin_name,"./md2/staff1_brown.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[STAFF_1].attack_up1,"slashtwo01");
	my_strcp(actors_defs[draegoni_male].weapon[STAFF_1].attack_up2,"slashtwo01");
	my_strcp(actors_defs[draegoni_male].weapon[STAFF_1].attack_down1,"hacktwo01");
	my_strcp(actors_defs[draegoni_male].weapon[STAFF_1].attack_down2,"hacktwo01");
	actors_defs[draegoni_male].weapon[STAFF_1].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_male].weapon[STAFF_2].model_name,"./md2/staff1_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[STAFF_2].skin_name,"./md2/staff1_green.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[STAFF_2].attack_up1,"slashtwo01");
	my_strcp(actors_defs[draegoni_male].weapon[STAFF_2].attack_up2,"slashtwo01");
	my_strcp(actors_defs[draegoni_male].weapon[STAFF_2].attack_down1,"hacktwo01");
	my_strcp(actors_defs[draegoni_male].weapon[STAFF_2].attack_down2,"hacktwo01");
	actors_defs[draegoni_male].weapon[STAFF_2].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_male].weapon[STAFF_3].model_name,"./md2/staff2_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[STAFF_3].skin_name,"./md2/staff3.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[STAFF_3].attack_up1,"slashtwo01");
	my_strcp(actors_defs[draegoni_male].weapon[STAFF_3].attack_up2,"slashtwo01");
	my_strcp(actors_defs[draegoni_male].weapon[STAFF_3].attack_down1,"hacktwo01");
	my_strcp(actors_defs[draegoni_male].weapon[STAFF_3].attack_down2,"hacktwo01");
	actors_defs[draegoni_male].weapon[STAFF_3].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_male].weapon[STAFF_4].model_name,"./md2/staff3_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[STAFF_4].skin_name,"./md2/staff4.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[STAFF_4].attack_up1,"slashtwo01");
	my_strcp(actors_defs[draegoni_male].weapon[STAFF_4].attack_up2,"slashtwo01");
	my_strcp(actors_defs[draegoni_male].weapon[STAFF_4].attack_down1,"hacktwo01");
	my_strcp(actors_defs[draegoni_male].weapon[STAFF_4].attack_down2,"hacktwo01");
	actors_defs[draegoni_male].weapon[STAFF_4].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_male].weapon[HAMMER_1].model_name,"./md2/warhammer1_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[HAMMER_1].skin_name,"./md2/warhammer1.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[HAMMER_1].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[HAMMER_1].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[HAMMER_1].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[HAMMER_1].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[HAMMER_1].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_male].weapon[HAMMER_2].model_name,"./md2/warhammer2_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[HAMMER_2].skin_name,"./md2/warhammer2.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[HAMMER_2].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[HAMMER_2].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[HAMMER_2].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[HAMMER_2].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[HAMMER_2].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_male].weapon[PICKAX].model_name,"./md2/pickaxe1_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[PICKAX].skin_name,"./md2/pickaxe1.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[PICKAX].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[PICKAX].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[PICKAX].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[PICKAX].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[PICKAX].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_male].weapon[PICKAX_MAGIC].model_name,"./md2/pickaxe1_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[PICKAX_MAGIC].skin_name,"./md2/pickaxe1.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[PICKAX_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[PICKAX_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[PICKAX_MAGIC].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[PICKAX_MAGIC].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[PICKAX_MAGIC].glow=GLOW_MAGIC;

	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_IRON].model_name,"./md2/axe1_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_IRON].skin_name,"./md2/axe1.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_IRON].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_IRON].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_IRON].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_IRON].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[BATTLEAXE_IRON].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_STEEL].model_name,"./md2/axe2_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_STEEL].skin_name,"./md2/axe2.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_STEEL].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_STEEL].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_STEEL].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_STEEL].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[BATTLEAXE_STEEL].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM].model_name,"./md2/axe3_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM].skin_name,"./md2/axe3.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM].glow=GLOW_NONE;

	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_IRON_FIRE].model_name,"./md2/axe1_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_IRON_FIRE].skin_name,"./md2/axe1.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_IRON_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_IRON_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_IRON_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_IRON_FIRE].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[BATTLEAXE_IRON_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_STEEL_FIRE].model_name,"./md2/axe2_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_STEEL_FIRE].skin_name,"./md2/axe2.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_STEEL_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_STEEL_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_STEEL_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_STEEL_FIRE].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[BATTLEAXE_STEEL_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_STEEL_COLD].model_name,"./md2/axe2_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_STEEL_COLD].skin_name,"./md2/axe2.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_STEEL_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_STEEL_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_STEEL_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_STEEL_COLD].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[BATTLEAXE_STEEL_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM_FIRE].model_name,"./md2/axe3_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM_FIRE].skin_name,"./md2/axe3.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM_FIRE].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM_FIRE].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM_FIRE].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM_FIRE].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM_FIRE].glow=GLOW_FIRE;

	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM_COLD].model_name,"./md2/axe3_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM_COLD].skin_name,"./md2/axe3.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM_COLD].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM_COLD].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM_COLD].attack_down1,"hackone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM_COLD].attack_down2,"hackone01");
	actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM_COLD].glow=GLOW_COLD;

	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM_MAGIC].model_name,"./md2/axe3_tall.md2");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM_MAGIC].skin_name,"./md2/axe3.bmp");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM_MAGIC].attack_up1,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM_MAGIC].attack_up2,"slashone01");
	my_strcp(actors_defs[draegoni_male].weapon[BATTLEAXE_TITANIUM_MAGIC].attack_down1,"hackone01");
	...
	actors_defs[draegoni_male].run_speed=2.0/18;
