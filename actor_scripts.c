...
void init_actor_defs()
{
	...
	my_strcp(actors_defs[orchan_male].skin[SKIN_TAN].hands_name,"./md2/hands_orchantan.bmp");
	...
	my_strcp(actors_defs[draegoni_female].skin[SKIN_TAN].hands_name,"./md2/hands_tan.bmp");
	my_strcp(actors_defs[draegoni_female].skin[SKIN_TAN].head_name,"./md2/head_draegoniftan.bmp");
	...
	my_strcp(actors_defs[draegoni_male].skin[SKIN_TAN].hands_name,"./md2/hands_draegonitan.bmp");
	my_strcp(actors_defs[draegoni_male].skin[SKIN_TAN].head_name,"./md2/head_draegonimtan.bmp");
	...
	my_strcp(actors_defs[draegoni_male].weapon[GLOVE_LEATHER].attack_down2,"kicktwo01");
	...
	my_strcp(actors_defs[draegoni_male].helmet[HELMET_IRON].model_name,"./md2/helmet1_tallm.md2");
	my_strcp(actors_defs[draegoni_male].helmet[HELMET_IRON].skin_name,"./md2/helmet1.bmp");
	my_strcp(actors_defs[draegoni_male].helmet[HELMET_FUR].model_name,"./md2/hat1_tallm.md2");
	my_strcp(actors_defs[draegoni_male].helmet[HELMET_FUR].skin_name,"./md2/hat1.bmp");
	my_strcp(actors_defs[draegoni_male].helmet[HELMET_LEATHER].model_name,"./md2/helmet2_tallm.md2");
