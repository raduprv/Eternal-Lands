...
el_key_def K_ITEM11 = {SDLK_UNDERSCORE, KMOD_LCTRL, "#K_ITEM11"};
...
el_key_def K_SPELL11 = {SDLK_UNDERSCORE, KMOD_LALT, "#K_SPELL11"};
...
static el_key_def *key_def_store[] =
{
	...
	&K_SPELL7, &K_SPELL8, &K_SPELL9, &K_STATS, &K_TABCOMPLETE, &K_TARGET_CLOSE, &K_TURNLEFT,
	&K_TURNRIGHT, &K_USE, &K_VIEWETHER, &K_VIEWHP, &K_VIEWNAMES, &K_VIEWTEXTASOVERTEXT, &K_WALK,
	&K_WINDOWS_ON_TOP, &K_ZOOMIN, &K_ZOOMOUT,
#ifdef ECDEBUGWIN
	&K_ECDEBUGWIN
#endif
};
