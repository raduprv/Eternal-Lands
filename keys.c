...
el_key_def K_VIEWFOOD = {SDLK_y, KMOD_LCTRL, "#K_VIEWFOOD"};
el_key_def K_FOODBAR = {SDLK_y, KMOD_LALT, "#K_FOODBAR"};
...
static el_key_def *key_def_store[] =
{
	...
	&K_WINSCALEINIT, &K_WINSCALEUP, &K_ZOOMIN, &K_ZOOMOUT, &K_FOODBAR, &K_VIEWFOOD,
#ifdef ECDEBUGWIN
	&K_ECDEBUGWIN
#endif
};
