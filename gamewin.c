...
Uint8 key_to_char (Uint32 unikey)
{
	...
	//Here, i think, best place for this ugly hack. And me clean font.c
	if (unikey >= 127 && unikey < 256 ) 
	{
	switch (unikey) 
	{
		case 193:return AACCENT;
                case 196:return AUMLAUT;
                case 197:return ARING;
                case 198:return AELIG;
                case 201:return EACCENT;
                case 205:return IACCENT;
                case 209:return ENYE;
                case 211:return OACCENT;
                case 214:return OUMLAUT;
                case 216:return OSLASH;
                case 218:return UACCENT;
                case 220:return UUMLAUT;
                case 223:return DOUBLES;
                case 224:return AGRAVE;
                case 225:return aACCENT;
                case 226:return ACIRC;
                case 228:return aUMLAUT;
		...
		case 235:return EUML;
  		case 236:
                case 237:return iACCENT;
                case 239:return IUML;
                case 241:return EnyE;
                case 242:
                case 243:return oACCENT;
                case 244:return OCIRC;
                case 246:return oUMLAUT;
                case 248:return oSLASH;
                case 249:return uGRAVE;
                case 250:return uACCENT;
                case 252:return uUMLAUT;
	}
	}
	//Set hook for russian utf-16 jyk.
	else if (unikey >= 1025 && unikey <= 1105 ) 
	{
        switch (unikey) {
		//begin remap Russian letter to exist english
		case 1040:return 65; //А
		case 1042:return 66; //В
		case 1057:return 67; //С
		case 1045:return 69; //Е
		case 1053:return 72; //Н
		case 1050:return 75; //К
		case 1052:return 77; //М
		case 1054:return 79; //О
		case 1056:return 80; //Р
		case 1058:return 84; //Т
		case 1061:return 88; //Х
		case 1072:return 97; //а
		case 1066:
		case 1068:return 98; //Ь
		case 1089:return 99; //c
		case 1077:return 101; //e
		case 1087:return 110; //n
		case 1086:return 111; //o
		case 1088:return 112; //p
		case 1075:return 114; //r
		case 1093:return 120; //x
		case 1091:return 121; //y
		case 1105:return EUML;//ё
		case 1073:return 54; //б
		case 1076:return 103;//д
		case 1025:return EACCENT; //Ё
		case 1080:return 117; //и
		case 1081:return uGRAVE; //й
		case 1047:return 51; //З
	}
		//begin remap to new letter
	switch (unikey) {
		case 1041:return 217;//Б
                case 1043:return 218;//Г
                case 1044:return 219;//Д
                case 1046:return 220;//Ж
                case 1090:return 221;//т
                case 1048:return 222;//И
                case 1049:return 223;//Й
                case 1051:return 224;//Л
                case 1055:return 225;//П
                case 1062:return 226;//Ц
                case 1063:return 227;//Ч
                case 1064:return 228;//Ш
                case 1065:return 229;//Щ
                case 1074:return 230;//в
                case 1067:return 231;//Ы
                case 1069:return 232;//Э
                case 1070:return 233;//Ю
                case 1071:return 234;//Я
                case 1078:return 235;//ж
		case 1075:return 236;//г
                case 1079:return 237;//з
                case 1060:
		case 1092:return 238;//ф
		case 1084:return 239;//м
                case 1083:return 240;//л
                case 1085:return 241;//н
                case 1094:return 242;//ц
                case 1095:return 243;//ч
                case 1096:return 244;//ш
                case 1097:return 245;//щ
                case 1059:return 246;//У
                case 1099:return 247;//ы
                case 1101:return 248;//э
                case 1102:return 249;//ю
                case 1103:return 250;//я
                case 1098:
		case 1100:return 251;//ь
                case 1082:return 252;//к		
	}
	}
