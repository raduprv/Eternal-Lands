...
#ifdef CONTEXT_MENUS
	add_var(OPT_BOOL,"cm_banner_enabled", "cmbanner", &cm_banner_enabled, change_var, 1,"Enable Name/Health Text Context Menu","Enable the context menu on your players name/health banner.",HUD);
#endif	 
