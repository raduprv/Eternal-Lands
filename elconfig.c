...
static void change_logo_click_var(int * var)
{
	*var= !*var;
	if (game_root_win >= 0)
...
#ifdef ANDROID
	add_var(OPT_BOOL,"logo_click_to_url","logoclick",&logo_click_to_url,change_logo_click_var,0,"Logo Click To URL","Toggle clicking the LOGO opening a browser window",HUD);
#else
