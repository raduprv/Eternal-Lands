...
static void init_ELC_vars(void)
{
	...
	add_var(OPT_BOOL,"show_indicators","showindicators",&show_hud_indicators,toggle_hud_indicators_window,1,"Show Status Indicators in HUD","Show status indicators for special day, harvesting and poision.",HUD);
