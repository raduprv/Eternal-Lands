...
static void init_ELC_vars(void)
{
	...
	add_var(OPT_FLOAT,"minimap_win_scale","chancolswinscale",get_scale_WM(MW_MINIMAP),change_win_scale_factor,1.0f,"Minimap window scaling factor",win_scale_description,FONT,win_scale_min,win_scale_max,win_scale_step);
