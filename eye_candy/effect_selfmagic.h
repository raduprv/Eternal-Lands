...
public: 
  ...
  SelfMagicEffect(EyeCandy* _base, bool* _dead, Vec3* _pos, const SelfMagicType _type, const Uint16 _LOD);
  ~SelfMagicEffect(); 
  
  virtual EffectEnum get_type() { return EC_SELFMAGIC; };
  bool idle(const Uint64 usec);
  void draw(const Uint64 usec);
  static Uint64 get_max_end_time() { return 4000000; };
  virtual Uint64 get_expire_time() { return 4000000 + born; };
...
{
public:
  SelfMagicParticle(Effect* _effect, ParticleMover* _mover, const Vec3 _pos, const Vec3 _velocity, const coord_t _size, const alpha_t _alpha, const color_t red, const color_t green, const color_t blue, Texture* _texture, const Uint16 _LOD, const SelfMagicEffect::SelfMagicType _type);
  ~SelfMagicParticle() {}
