...
public: 
  ...
  BreathEffect(EyeCandy* _base, bool* _dead, Vec3* _pos, Vec3* _target, const std::vector<ec::Obstruction*> _obstructions, const BreathType _type, const u_int16_t _LOD, const percent_t _scale);
  ~BreathEffect(); 
...
{
public:
  BreathParticle(Effect* _effect, ParticleMover* _mover, const Vec3 _pos, const Vec3 _velocity, const coord_t _size, const alpha_t _alpha, const color_t red, const color_t green, const color_t blue, Texture* _texture, const u_int16_t _LOD, const BreathEffect::BreathType _type);
  ~BreathParticle() {}
...
{
public:
  BreathSmokeParticle(Effect* _effect, ParticleMover* _mover, const Vec3 _pos, const Vec3 _velocity, const coord_t _size, const alpha_t _alpha, Texture* _texture, const u_int16_t _LOD, const BreathEffect::BreathType _type);
  ~BreathSmokeParticle() {}
