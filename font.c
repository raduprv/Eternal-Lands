...
{
	draw_string_small_shadowed_scaled(x, y, our_string, max_lines, fr, fg, fb, br, bg, bb, 1.0);
}
...
{
	draw_string_small_shadowed_scaled(x, y, our_string, max_lines, fr, fg, fb, br, bg, bb, ui_scale);
}
