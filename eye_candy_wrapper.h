...
//****************************************************************************//
  ...
  ec_reference ec_create_selfmagic_teleport_to_the_portals_room(float x, float y, float z, int LOD);
  ec_reference ec_create_selfmagic_teleport_to_the_portals_room2(actor* caster, int LOD);
  ec_reference ec_create_selfmagic_magic_immunity(float x, float y, float z, int LOD);
  ...
  ec_reference ec_create_sword_sunbreaker(float start_x, float start_y, float start_z, float end_x, float end_y, float end_z, int LOD);
  ec_reference ec_create_sword_orc_slayer(float start_x, float start_y, float start_z, float end_x, float end_y, float end_z, int LOD);
  ec_reference ec_create_sword_eagle_wing(float start_x, float start_y, float start_z, float end_x, float end_y, float end_z, int LOD);
  ec_reference ec_create_sword_jagged_saber(float start_x, float start_y, float start_z, float end_x, float end_y, float end_z, int LOD);
